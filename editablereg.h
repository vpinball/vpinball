...
public:
  ...
  static IEditable* Create(ItemTypeEnum type) { return FindOrFail(type)->createFunc(); }
  ...
  static int GetTypeNameStringID(ItemTypeEnum type) { return FindOrFail(type)->typeNameID; }
  ...
  static int GetCursorID(ItemTypeEnum type) { return FindOrFail(type)->cursorID; }

  static unsigned int GetAllowedViews(ItemTypeEnum type) { return FindOrFail(type)->allowedViews; }
