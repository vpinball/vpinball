...
private:
   ...
   typedef std::function<void(LiveUI*, bool is_live, float prev, float v)> OnFloatPropChange;
   typedef std::function<void(LiveUI *, bool is_live, bool prev, bool v)> OnBoolPropChange;
