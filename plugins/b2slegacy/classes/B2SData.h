...
public:
   ...
   std::map<int, std::map<int, VPXTexture>>* GetRotatingImages() { return &m_rotatingImages; }
   ...
   GenericDictionaryIgnoreCase<VPXTexture>* GetReelImages() { return &m_reelImages; }
   GenericDictionaryIgnoreCase<VPXTexture>* GetReelIntermediateImages() { return &m_reelIntermediateImages; }
   GenericDictionaryIgnoreCase<VPXTexture>* GetReelIlluImages() { return &m_reelIlluImages; }
   GenericDictionaryIgnoreCase<VPXTexture>* GetReelIntermediateIlluImages() { return &m_reelIntermediateIlluImages; }
...
private:
   ...
   int m_dmdType = 0;
   int m_grillHeight = 0;
   int m_smallGrillHeight = 0;
   SDL_Point m_dmdDefaultLocation = { 0, 0 };
   bool m_dualBackglass = false;
   bool m_launchBackglass = true;
   bool m_backglassVisible = false;
   bool m_useIlluminationLocks = false;
   bool m_useZOrder = false;
   bool m_useDMDZOrder = false;
   bool m_onAndOffImage = false;
   bool m_offImageVisible = false;
   std::map<int, std::map<int, VPXTexture>> m_rotatingImages;
   ...
   eRomIDType m_usedTopRomIDType4Authentic = eRomIDType_NotDefined;
   eRomIDType m_usedTopRomIDType4Fantasy = eRomIDType_NotDefined;
   eRomIDType m_usedSecondRomIDType4Authentic = eRomIDType_NotDefined;
   eRomIDType m_usedSecondRomIDType4Fantasy = eRomIDType_NotDefined;
   ...
   bool m_useRotatingImage = false;
   bool m_useMechRotatingImage = false;
   ...
   GenericDictionaryIgnoreCase<VPXTexture> m_reelImages;
   GenericDictionaryIgnoreCase<VPXTexture> m_reelIntermediateImages;
   GenericDictionaryIgnoreCase<VPXTexture> m_reelIlluImages;
   GenericDictionaryIgnoreCase<VPXTexture> m_reelIntermediateIlluImages;
