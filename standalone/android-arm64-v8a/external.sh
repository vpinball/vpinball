...
if [ ! -f "../${CACHE_DIR}/${CACHE_NAME}.cache" ]; then
   ...
   cp build/libfreeimage.so ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cd ..
   touch "../${CACHE_DIR}/${CACHE_NAME}.cache"
fi

cp ../${CACHE_DIR}/${CACHE_NAME}/lib/libfreeimage.so ../external/lib
...
if [ ! -f "../${CACHE_DIR}/${CACHE_NAME}.cache" ]; then
   ...
   mkdir -p ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cp build/libpinmame.so ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cd ..
   touch "../${CACHE_DIR}/${CACHE_NAME}.cache"
fi

cp -r ../${CACHE_DIR}/${CACHE_NAME}/include/* ../external/include
cp -a ../${CACHE_DIR}/${CACHE_NAME}/lib/libpinmame.so ../external/lib
