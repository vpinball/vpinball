...
* 10/23/25
    * Bump libdmdutil to support Pixelcade v2 devices

* 09/22/25
    * Bump libdof to 0.4.5, fixes LedWiz devices

* 09/18/25
    * Bump libdof to preserve static effects while receiving other events

* 09/11/25
    * Bump libdof to support static effects and logging to a file

* 09/08/25
    * Update SDL2 to 2.32.10
    * Backport SDLK_EQUALS and GetFullPathNameW fixes (thanks @Yuki)

* 09/04/25
    * Update libdof to support Ultimarc PacLED64 devices

* 08/28/25
    * Update libdof to support matrix and bitmap effects
    * Update libdmdutil to 0.10.0 (also updates libserum-concentrate, libzedmd, libpupdmd)

* 06/20/25
    * Update libdof to support Pinscape, Pinscape Pico, and TeensyStripController devices

* 05/29/25
    * Move MacOS code signing from CMake to Github Action 

* 05/27/25
    * Fix long standing disappearing LED displays in B2S (thanks @evilwraith)

* 05/24/25
    * Added support to use SDL Joysticks via `GamepadOverride=0`

* 05/19/25
    * Bump Wine source to wine-7f833db11ffea4f3f4fa07be31d30559aff9c5fb (10.8)
    * Backport 10.8.1 PuP and B2S enhancements
    * Backport 10.8.1 robin_hood to ankerl::unordered_dense migration

* 05/05/25
    * Update to libpinmame 3.7

* 04/25/25
    * Add support for B2S 2.1.3 updates
...
* 03/30/25
    ...
    * Removed default xbox joystick configuration
...
* 01/26/25
    * Bump libdmdutil (libzedmd, requires ZeDMD 5.1.0)
