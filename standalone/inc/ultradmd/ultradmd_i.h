/*** Autogenerated by WIDL 10.0-rc4 from ../inc/ultradmd/UltraDMD.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IDMDObject_QueryInterface(IDMDObject* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IDMDObject_AddRef(IDMDObject* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IDMDObject_Release(IDMDObject* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IDMDObject_GetTypeInfoCount(IDMDObject* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IDMDObject_GetTypeInfo(IDMDObject* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IDMDObject_GetIDsOfNames(IDMDObject* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IDMDObject_Invoke(IDMDObject* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IDMDObject methods ***/
static inline HRESULT IDMDObject_get_FloatProperty(IDMDObject* This,single *pRetVal) {
    return This->lpVtbl->get_FloatProperty(This,pRetVal);
}
static inline HRESULT IDMDObject_put_FloatProperty(IDMDObject* This,single pRetVal) {
    return This->lpVtbl->put_FloatProperty(This,pRetVal);
}
static inline HRESULT IDMDObject_Init(IDMDObject* This) {
    return This->lpVtbl->Init(This);
}
static inline HRESULT IDMDObject_Uninit(IDMDObject* This) {
    return This->lpVtbl->Uninit(This);
}
static inline HRESULT IDMDObject_GetMajorVersion(IDMDObject* This,LONG *pRetVal) {
    return This->lpVtbl->GetMajorVersion(This,pRetVal);
}
static inline HRESULT IDMDObject_GetMinorVersion(IDMDObject* This,LONG *pRetVal) {
    return This->lpVtbl->GetMinorVersion(This,pRetVal);
}
static inline HRESULT IDMDObject_GetBuildNumber(IDMDObject* This,LONG *pRetVal) {
    return This->lpVtbl->GetBuildNumber(This,pRetVal);
}
static inline HRESULT IDMDObject_SetVisibleVirtualDMD(IDMDObject* This,VARIANT_BOOL bHide,VARIANT_BOOL *pRetVal) {
    return This->lpVtbl->SetVisibleVirtualDMD(This,bHide,pRetVal);
}
static inline HRESULT IDMDObject_SetFlipY(IDMDObject* This,VARIANT_BOOL flipY,VARIANT_BOOL *pRetVal) {
    return This->lpVtbl->SetFlipY(This,flipY,pRetVal);
}
static inline HRESULT IDMDObject_IsRendering(IDMDObject* This,VARIANT_BOOL *pRetVal) {
    return This->lpVtbl->IsRendering(This,pRetVal);
}
static inline HRESULT IDMDObject_CancelRendering(IDMDObject* This) {
    return This->lpVtbl->CancelRendering(This);
}
static inline HRESULT IDMDObject_CancelRenderingWithId(IDMDObject* This,BSTR sceneId) {
    return This->lpVtbl->CancelRenderingWithId(This,sceneId);
}
static inline HRESULT IDMDObject_Clear(IDMDObject* This) {
    return This->lpVtbl->Clear(This);
}
static inline HRESULT IDMDObject_SetProjectFolder(IDMDObject* This,BSTR basePath) {
    return This->lpVtbl->SetProjectFolder(This,basePath);
}
static inline HRESULT IDMDObject_SetVideoStretchMode(IDMDObject* This,LONG mode) {
    return This->lpVtbl->SetVideoStretchMode(This,mode);
}
static inline HRESULT IDMDObject_SetScoreboardBackgroundImage(IDMDObject* This,BSTR filename,LONG selectedBrightness,LONG unselectedBrightness) {
    return This->lpVtbl->SetScoreboardBackgroundImage(This,filename,selectedBrightness,unselectedBrightness);
}
static inline HRESULT IDMDObject_CreateAnimationFromImages(IDMDObject* This,LONG fps,VARIANT_BOOL loop,BSTR imagelist,LONG *pRetVal) {
    return This->lpVtbl->CreateAnimationFromImages(This,fps,loop,imagelist,pRetVal);
}
static inline HRESULT IDMDObject_RegisterVideo(IDMDObject* This,LONG videoStretchMode,VARIANT_BOOL loop,BSTR videoFilename,LONG *pRetVal) {
    return This->lpVtbl->RegisterVideo(This,videoStretchMode,loop,videoFilename,pRetVal);
}
static inline HRESULT IDMDObject_RegisterFont(IDMDObject* This,BSTR file,LONG *pRetVal) {
    return This->lpVtbl->RegisterFont(This,file,pRetVal);
}
static inline HRESULT IDMDObject_UnregisterFont(IDMDObject* This,LONG registeredFont) {
    return This->lpVtbl->UnregisterFont(This,registeredFont);
}
static inline HRESULT IDMDObject_DisplayVersionInfo(IDMDObject* This) {
    return This->lpVtbl->DisplayVersionInfo(This);
}
static inline HRESULT IDMDObject_DisplayScoreboard(IDMDObject* This,LONG cPlayers,LONG highlightedPlayer,LONG score1,LONG score2,LONG score3,LONG score4,BSTR lowerLeft,BSTR lowerRight) {
    return This->lpVtbl->DisplayScoreboard(This,cPlayers,highlightedPlayer,score1,score2,score3,score4,lowerLeft,lowerRight);
}
static inline HRESULT IDMDObject_DisplayScoreboard00(IDMDObject* This,LONG cPlayers,LONG highlightedPlayer,LONG score1,LONG score2,LONG score3,LONG score4,BSTR lowerLeft,BSTR lowerRight) {
    return This->lpVtbl->DisplayScoreboard00(This,cPlayers,highlightedPlayer,score1,score2,score3,score4,lowerLeft,lowerRight);
}
static inline HRESULT IDMDObject_DisplayScene00(IDMDObject* This,BSTR background,BSTR toptext,LONG topBrightness,BSTR bottomtext,LONG bottomBrightness,LONG animateIn,LONG pauseTime,LONG animateOut) {
...
static inline HRESULT IDMDObject_DisplayScene00Ex(IDMDObject* This,BSTR background,BSTR toptext,LONG topBrightness,LONG topOutlineBrightness,BSTR bottomtext,LONG bottomBrightness,LONG bottomOutlineBrightness,LONG animateIn,LONG pauseTime,LONG animateOut) {
...
static inline HRESULT IDMDObject_DisplayScene00ExWithId(IDMDObject* This,BSTR sceneId,VARIANT_BOOL cancelPrevious,BSTR background,BSTR toptext,LONG topBrightness,LONG topOutlineBrightness,BSTR bottomtext,LONG bottomBrightness,LONG bottomOutlineBrightness,LONG animateIn,LONG pauseTime,LONG animateOut) {
...
static inline HRESULT IDMDObject_ModifyScene00(IDMDObject* This,BSTR id,BSTR toptext,BSTR bottomtext) {
    return This->lpVtbl->ModifyScene00(This,id,toptext,bottomtext);
}
static inline HRESULT IDMDObject_ModifyScene00Ex(IDMDObject* This,BSTR id,BSTR toptext,BSTR bottomtext,LONG pauseTime) {
    return This->lpVtbl->ModifyScene00Ex(This,id,toptext,bottomtext,pauseTime);
}
static inline HRESULT IDMDObject_DisplayScene01(IDMDObject* This,BSTR sceneId,BSTR background,BSTR text,LONG textBrightness,LONG textOutlineBrightness,LONG animateIn,LONG pauseTime,LONG animateOut) {
...
static inline HRESULT IDMDObject_DisplayText(IDMDObject* This,BSTR text,LONG textBrightness,LONG textOutlineBrightness) {
    return This->lpVtbl->DisplayText(This,text,textBrightness,textOutlineBrightness);
}
static inline HRESULT IDMDObject_ScrollingCredits(IDMDObject* This,BSTR background,BSTR text,LONG textBrightness,LONG animateIn,LONG pauseTime,LONG animateOut) {
