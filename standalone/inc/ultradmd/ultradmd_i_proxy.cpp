...
STDMETHODIMP UltraDMDDMDObject::GetIDsOfNames(REFIID /*riid*/, LPOLESTR* rgszNames, UINT cNames, LCID lcid, DISPID* rgDispId) {
	static struct {
		const WCHAR *name;
		DISPID dispId;
	} namesIdsList[] = {
			...
			{ L"DmdColoredPixels", 0x70020017 },
			{ L"DmdPixels", 0x70020018 },
...
STDMETHODIMP UltraDMDDMDObject::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
