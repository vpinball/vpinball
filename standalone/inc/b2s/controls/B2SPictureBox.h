...
public:
   ...
   virtual void SetVisible(bool visible) { if (IsVisible() != visible) { m_setThruAnimation = visible; B2SBaseBox::SetVisible(visible); } };
   ...
   void SetBackgroundImage(SDL_Surface* pBackgroundImage) override { m_pBackgroundImage = pBackgroundImage; Invalidate(); };
