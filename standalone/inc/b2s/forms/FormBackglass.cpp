                         ...
                         if (string_starts_with_case_insensitive(idJoin, "L")) {
                            if (id1 > 0)
                               for (int i = 1; i <= randomquality; i++)
                                  m_pB2SData->GetUsedRandomAnimationLampIDs()->Add(id1, new AnimationInfo(name, false));
                         }
                         else if (string_starts_with_case_insensitive(idJoin, "S")) {
                            if (id1 > 0)
                               for (int i = 1; i <= randomquality; i++)
                                  m_pB2SData->GetUsedRandomAnimationSolenoidIDs()->Add(id1, new AnimationInfo(name, false));
                         }
                         else if (string_starts_with_case_insensitive(idJoin, "GI")) {
                            if (id2 > 0)
                               m_pB2SData->GetUsedRandomAnimationGIStringIDs()->Add(id2, new AnimationInfo(name, false));
                         }
                         else if (string_starts_with_case_insensitive(idJoin, "G")) {
                            if (id1 > 0)
                               m_pB2SData->GetUsedRandomAnimationGIStringIDs()->Add(id1, new AnimationInfo(name, false));
                         }
                         else if (string_starts_with_case_insensitive(idJoin, "IL")) {
                            if (id2 > 0)
                               m_pB2SData->GetUsedRandomAnimationLampIDs()->Add(id2, new AnimationInfo(name, true));
                         }
                         else if (string_starts_with_case_insensitive(idJoin, "IS")) {
                            if (id2 > 0)
                               m_pB2SData->GetUsedRandomAnimationSolenoidIDs()->Add(id2, new AnimationInfo(name, true));
                         }
                         else if (string_starts_with_case_insensitive(idJoin, "IGI")) {
                            if (id3 > 0)
                               m_pB2SData->GetUsedRandomAnimationGIStringIDs()->Add(id3, new AnimationInfo(name, true));
                         }
                         else if (string_starts_with_case_insensitive(idJoin, "IG")) {
                            if (id2 > 0)
                               m_pB2SData->GetUsedRandomAnimationGIStringIDs()->Add(id2, new AnimationInfo(name, true));
                         }
                         else if (string_starts_with_case_insensitive(idJoin, "I")) {
                            if (id1 > 0)
                               m_pB2SData->GetUsedRandomAnimationLampIDs()->Add(id1, new AnimationInfo(name, true));
                         }
                         else {
                            if (id0 > 0)
                               m_pB2SData->GetUsedRandomAnimationLampIDs()->Add(id0, new AnimationInfo(name, false));
                         }
                      }
                   }
                }
