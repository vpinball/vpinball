...
void B2SSettings::ClearAll()
{
   ...
   m_glowIndex = -1;
   m_defaultGlow = -1;
   m_hideGrill = (B2SSettingsCheckedState)LoadValueWithDefault(regKey[RegName::Standalone], "B2SHideGrill"s, (int)B2SSettingsCheckedState_Indeterminate);
   m_hideB2SDMD = LoadValueWithDefault(regKey[RegName::Standalone], "B2SHideB2SDMD"s, false);
   m_hideDMD = (B2SSettingsCheckedState)LoadValueWithDefault(regKey[RegName::Standalone], "B2SHideDMD"s, (int)B2SSettingsCheckedState_Indeterminate);
   ...
   m_frameSkip = LoadValueWithDefault(regKey[RegName::Standalone], "B2SFrameSkip"s, 0);
}