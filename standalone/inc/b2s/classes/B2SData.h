...
public:
   ...
   bool IsInfoDirty() const { return m_infoDirty; }
   void SetInfoDirty(bool infoDirty) { m_infoDirty = infoDirty; }
   ...
   bool GetLampsData();
   bool GetSolenoidsData();
   bool GetGIStringsData();
   bool GetLEDsData();
   bool GetUseRomLamps();
   bool GetUseRomSolenoids();
   bool GetUseRomGIStrings();
   bool GetUseRomMechs();
   bool GetUseAnimationLamps();
   bool GetUseAnimationSolenoids();
   bool GetUseAnimationGIStrings();
   bool GetUseRomReelLamps();
   bool GetUseLEDs();
   bool GetUseLEDDisplays();
   bool GetUseReels();
...
private:
   ...
   bool m_lampsInfoDirty;
   bool m_solenoidsInfoDirty;
   bool m_giStringsInfoDirty;
   bool m_ledInfoDirty;
