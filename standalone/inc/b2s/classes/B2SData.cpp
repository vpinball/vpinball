...
{
   return m_valid && (GetUseRomLamps() || GetUseAnimationLamps()) && !m_pB2SSettings->IsAllOff() && !m_pB2SSettings->IsLampsOff();
}

bool B2SData::GetSolenoidsData()
{
   return m_valid && (GetUseRomSolenoids() || GetUseAnimationSolenoids()) && !m_pB2SSettings->IsAllOff() && !m_pB2SSettings->IsSolenoidsOff();
}

bool B2SData::GetGIStringsData()
{
   return m_valid && (GetUseRomGIStrings() || GetUseAnimationGIStrings()) && !m_pB2SSettings->IsAllOff() && !m_pB2SSettings->IsGIStringsOff();
}

bool B2SData::GetLEDsData()
{
   return m_valid && (GetUseLEDs() || GetUseLEDDisplays() || GetUseReels()) && !m_pB2SSettings->IsAllOff() && !m_pB2SSettings->IsLEDsOff();
}
