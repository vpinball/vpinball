...
{
   if (!LoadValueWithDefault(regKey[RegName::Standalone], "B2S"s, false))
      return;
   ...
   m_pBackglassWindow = new VP::Window("b2s_backglass",
      ...
      LoadValueWithDefault(regKey[RegName::Standalone], "B2SBackglassFrameSkip"s, 0));
   ...
   m_pDMDWindow = new VP::Window("b2s_dmd",
      ...
      LoadValueWithDefault(regKey[RegName::Standalone], "B2SDMDFrameSkip"s, 0));
}
