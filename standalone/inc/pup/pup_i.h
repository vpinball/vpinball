/*** Autogenerated by WIDL 10.0-rc4 from ../inc/pup/PUP.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static inline HRESULT IPinDisplay_QueryInterface(IPinDisplay* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IPinDisplay_AddRef(IPinDisplay* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IPinDisplay_Release(IPinDisplay* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static inline HRESULT IPinDisplay_GetTypeInfoCount(IPinDisplay* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static inline HRESULT IPinDisplay_GetTypeInfo(IPinDisplay* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static inline HRESULT IPinDisplay_GetIDsOfNames(IPinDisplay* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static inline HRESULT IPinDisplay_Invoke(IPinDisplay* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IPinDisplay methods ***/
static inline HRESULT IPinDisplay_Init(IPinDisplay* This,LONG ScreenNum,BSTR RootDir) {
    return This->lpVtbl->Init(This,ScreenNum,RootDir);
}
static inline HRESULT IPinDisplay_playlistadd(IPinDisplay* This,LONG ScreenNum,BSTR folder,LONG sort,LONG restSeconds) {
    return This->lpVtbl->playlistadd(This,ScreenNum,folder,sort,restSeconds);
}
static inline HRESULT IPinDisplay_playlistplay(IPinDisplay* This,LONG ScreenNum,BSTR playlist) {
    return This->lpVtbl->playlistplay(This,ScreenNum,playlist);
}
static inline HRESULT IPinDisplay_playlistplayex(IPinDisplay* This,LONG ScreenNum,BSTR playlist,BSTR playfilename,LONG volume,LONG forceplay) {
    return This->lpVtbl->playlistplayex(This,ScreenNum,playlist,playfilename,volume,forceplay);
}
static inline HRESULT IPinDisplay_play(IPinDisplay* This,LONG ScreenNum,BSTR playlist,BSTR playfilename) {
    return This->lpVtbl->play(This,ScreenNum,playlist,playfilename);
}
static inline HRESULT IPinDisplay_setWidth(IPinDisplay* This,LONG ScreenNum,LONG width) {
    return This->lpVtbl->setWidth(This,ScreenNum,width);
}
static inline HRESULT IPinDisplay_setHeight(IPinDisplay* This,LONG ScreenNum,LONG Height) {
    return This->lpVtbl->setHeight(This,ScreenNum,Height);
}
static inline HRESULT IPinDisplay_setPosX(IPinDisplay* This,LONG ScreenNum,LONG Posx) {
    return This->lpVtbl->setPosX(This,ScreenNum,Posx);
}
static inline HRESULT IPinDisplay_setPosY(IPinDisplay* This,LONG ScreenNum,LONG PosY) {
    return This->lpVtbl->setPosY(This,ScreenNum,PosY);
}
static inline HRESULT IPinDisplay_setAspect(IPinDisplay* This,LONG ScreenNum,LONG aspectWide,LONG aspectHigh) {
    return This->lpVtbl->setAspect(This,ScreenNum,aspectWide,aspectHigh);
}
static inline HRESULT IPinDisplay_setVolume(IPinDisplay* This,LONG ScreenNum,LONG vol) {
    return This->lpVtbl->setVolume(This,ScreenNum,vol);
}
static inline HRESULT IPinDisplay_playpause(IPinDisplay* This,LONG ScreenNum) {
    return This->lpVtbl->playpause(This,ScreenNum);
}
static inline HRESULT IPinDisplay_playresume(IPinDisplay* This,LONG ScreenNum) {
    return This->lpVtbl->playresume(This,ScreenNum);
}
static inline HRESULT IPinDisplay_playstop(IPinDisplay* This,LONG ScreenNum) {
    return This->lpVtbl->playstop(This,ScreenNum);
}
static inline HRESULT IPinDisplay_CloseApp(IPinDisplay* This) {
    return This->lpVtbl->CloseApp(This);
}
static inline HRESULT IPinDisplay_get_isPlaying(IPinDisplay* This,LONG ScreenNum,LONG *Value) {
    return This->lpVtbl->get_isPlaying(This,ScreenNum,Value);
}
static inline HRESULT IPinDisplay_put_isPlaying(IPinDisplay* This,LONG ScreenNum,LONG Value) {
    return This->lpVtbl->put_isPlaying(This,ScreenNum,Value);
}
static inline HRESULT IPinDisplay_SetLength(IPinDisplay* This,LONG ScreenNum,LONG StopSecs) {
    return This->lpVtbl->SetLength(This,ScreenNum,StopSecs);
}
static inline HRESULT IPinDisplay_SetLoop(IPinDisplay* This,LONG ScreenNum,LONG LoopState) {
    return This->lpVtbl->SetLoop(This,ScreenNum,LoopState);
}
static inline HRESULT IPinDisplay_SetBackGround(IPinDisplay* This,LONG ScreenNum,LONG Mode) {
    return This->lpVtbl->SetBackGround(This,ScreenNum,Mode);
}
static inline HRESULT IPinDisplay_BlockPlay(IPinDisplay* This,LONG ScreenNum,LONG Mode) {
    return This->lpVtbl->BlockPlay(This,ScreenNum,Mode);
}
static inline HRESULT IPinDisplay_SetScreen(IPinDisplay* This,LONG ScreenNum) {
    return This->lpVtbl->SetScreen(This,ScreenNum);
}
static inline HRESULT IPinDisplay_SetScreenEx(IPinDisplay* This,LONG ScreenNum,LONG xpos,LONG ypos,LONG swidth,LONG sheight,LONG popup) {
    return This->lpVtbl->SetScreenEx(This,ScreenNum,xpos,ypos,swidth,sheight,popup);
}
static inline HRESULT IPinDisplay_get_SN(IPinDisplay* This,LONG *Value) {
    return This->lpVtbl->get_SN(This,Value);
}
static inline HRESULT IPinDisplay_put_SN(IPinDisplay* This,LONG Value) {
    return This->lpVtbl->put_SN(This,Value);
}
static inline HRESULT IPinDisplay_B2SData(IPinDisplay* This,BSTR tIndex,int Value) {
    return This->lpVtbl->B2SData(This,tIndex,Value);
}
static inline HRESULT IPinDisplay_get_B2SFilter(IPinDisplay* This,BSTR *Value) {
    return This->lpVtbl->get_B2SFilter(This,Value);
}
static inline HRESULT IPinDisplay_put_B2SFilter(IPinDisplay* This,BSTR Value) {
    return This->lpVtbl->put_B2SFilter(This,Value);
}
static inline HRESULT IPinDisplay_Show(IPinDisplay* This,LONG ScreenNum) {
    return This->lpVtbl->Show(This,ScreenNum);
}
static inline HRESULT IPinDisplay_Hide(IPinDisplay* This,LONG ScreenNum) {
    return This->lpVtbl->Hide(This,ScreenNum);
}
static inline HRESULT IPinDisplay_B2SInit(IPinDisplay* This,BSTR TName,BSTR RomName) {
    return This->lpVtbl->B2SInit(This,TName,RomName);
}
static inline HRESULT IPinDisplay_SendMSG(IPinDisplay* This,BSTR cMSG) {
    return This->lpVtbl->SendMSG(This,cMSG);
}
static inline HRESULT IPinDisplay_LabelNew(IPinDisplay* This,LONG ScreenNum,BSTR LabelName,BSTR FontName,LONG Size,LONG Color,LONG Angle,LONG xAlign,LONG yAlign,LONG xMargin,LONG yMargin,LONG PageNum,LONG Visible) {
...
static inline HRESULT IPinDisplay_LabelSet(IPinDisplay* This,LONG ScreenNum,BSTR LabelName,BSTR Caption,LONG Visible,BSTR Special) {
    return This->lpVtbl->LabelSet(This,ScreenNum,LabelName,Caption,Visible,Special);
}
static inline HRESULT IPinDisplay_LabelSetEx(IPinDisplay* This) {
    return This->lpVtbl->LabelSetEx(This);
}
static inline HRESULT IPinDisplay_LabelShowPage(IPinDisplay* This,LONG ScreenNum,LONG PageNum,LONG Seconds,BSTR Special) {
    return This->lpVtbl->LabelShowPage(This,ScreenNum,PageNum,Seconds,Special);
}
static inline HRESULT IPinDisplay_LabelInit(IPinDisplay* This,LONG ScreenNum) {
    return This->lpVtbl->LabelInit(This,ScreenNum);
}
static inline HRESULT IPinDisplay_get_GetGame(IPinDisplay* This,BSTR *Value) {
    return This->lpVtbl->get_GetGame(This,Value);
}
static inline HRESULT IPinDisplay_put_GetGame(IPinDisplay* This,BSTR Value) {
    return This->lpVtbl->put_GetGame(This,Value);
}
static inline HRESULT IPinDisplay_get_GetRoot(IPinDisplay* This,BSTR *Value) {
    return This->lpVtbl->get_GetRoot(This,Value);
}
static inline HRESULT IPinDisplay_put_GetRoot(IPinDisplay* This,BSTR Value) {
    return This->lpVtbl->put_GetRoot(This,Value);
}
static inline HRESULT IPinDisplay_SoundAdd(IPinDisplay* This,BSTR sname,BSTR fname,LONG svol,double sX,double sy,BSTR SP) {
    return This->lpVtbl->SoundAdd(This,sname,fname,svol,sX,sy,SP);
}
static inline HRESULT IPinDisplay_SoundPlay(IPinDisplay* This,BSTR sname) {
    return This->lpVtbl->SoundPlay(This,sname);
}
static inline HRESULT IPinDisplay_PuPSound(IPinDisplay* This,BSTR sname,LONG sX,LONG sy,LONG sz,LONG vol,BSTR SP) {
    return This->lpVtbl->PuPSound(This,sname,sX,sy,sz,vol,SP);
}
static inline HRESULT IPinDisplay_InitPuPMenu(IPinDisplay* This,LONG Param1) {
    return This->lpVtbl->InitPuPMenu(This,Param1);
}
static inline HRESULT IPinDisplay_get_B2SDisplays(IPinDisplay* This,BSTR *Value) {
    return This->lpVtbl->get_B2SDisplays(This,Value);
}
static inline HRESULT IPinDisplay_setVolumeCurrent(IPinDisplay* This,LONG ScreenNum,LONG vol) {
    return This->lpVtbl->setVolumeCurrent(This,ScreenNum,vol);
}
static inline HRESULT IPinDisplay_get_GameUpdate(IPinDisplay* This,BSTR GameTitle,LONG Func,LONG FuncData,BSTR Extra,LONG *Value) {
    return This->lpVtbl->get_GameUpdate(This,GameTitle,Func,FuncData,Extra,Value);
}
static inline HRESULT IPinDisplay_GrabDC(IPinDisplay* This,LONG pWidth,LONG pHeight,BSTR wintitle,VARIANT *pixels) {
    return This->lpVtbl->GrabDC(This,pWidth,pHeight,wintitle,pixels);
}
static inline HRESULT IPinDisplay_GetVersion(IPinDisplay* This,BSTR *pver) {
    return This->lpVtbl->GetVersion(This,pver);
}
static inline HRESULT IPinDisplay_GrabDC2(IPinDisplay* This,LONG pWidth,LONG pHeight,BSTR wintitle,SAFEARRAY **pixels) {
    return This->lpVtbl->GrabDC2(This,pWidth,pHeight,wintitle,pixels);
}
static inline HRESULT IPinDisplay_playevent(IPinDisplay* This,LONG ScreenNum,BSTR playlist,BSTR playfilename,LONG volume,LONG priority,LONG playtype,LONG Seconds,BSTR Special) {
    return This->lpVtbl->playevent(This,ScreenNum,playlist,playfilename,volume,priority,playtype,Seconds,Special);
}
static inline HRESULT IPinDisplay_SetPosVideo(IPinDisplay* This,LONG ScreenNum,LONG StartPos,LONG EndPos,LONG Mode,BSTR Special) {
    return This->lpVtbl->SetPosVideo(This,ScreenNum,StartPos,EndPos,Mode,Special);
}
static inline HRESULT IPinDisplay_PuPClose(IPinDisplay* This) {
