...
public:
   ...
   void SetMedia(const std::string& file, float volume, int priority);
...
private:
   ...
   void LoadTriggers();
   void ProcessQueue();
   void ProcessTrigger(PUPTrigger* pTrigger, int value);
   void ProcessRequest(PUPScreenRequest* pRequest);
