...
VPinMAMEController::VPinMAMEController()
{
   ...
   m_szPath = g_pvp->m_settings.LoadValueWithDefault(Settings::Standalone, "PinMAMEPath"s, ""s);
   ...
   m_szIniPath = g_pvp->m_settings.LoadValueWithDefault(Settings::Standalone, "PinMAMEIniPath"s, ""s);
