...
STDMETHODIMP Collection::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Collection_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP PinTable::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", PinTable_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP ScriptGlobalTable::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", ScriptGlobalTable_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP ScriptInterpreter::DebuggerModule::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", ScriptInterpreter_DebuggerModule_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Surface::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Surface_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP DragPoint::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", DragPoint_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Flipper::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Flipper_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Timer::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Timer_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Plunger::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Plunger_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Textbox::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Textbox_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Bumper::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Bumper_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Trigger::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Trigger_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Light::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Light_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Kicker::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Kicker_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Decal::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Decal_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Primitive::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Primitive_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP HitTarget::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", HitTarget_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Gate::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Gate_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Spinner::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Spinner_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Ramp::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Ramp_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Flasher::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Flasher_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Rubber::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Rubber_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP Ball::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", Ball_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP DispReel::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", DispReel_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP PartGroup::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", PartGroup_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
...
STDMETHODIMP LightSeq::Invoke(DISPID dispIdMember, REFIID /*riid*/, LCID lcid, WORD wFlags, DISPPARAMS* pDispParams, VARIANT* pVarResult, EXCEPINFO* pExcepInfo, UINT* puArgErr) {
	...
	if (SUCCEEDED(hres)) {
		...
		PLOGI.printf("%s (dispId=%d 0x%08x), wFlags=%d, hres=0x%08x (%s)", LightSeq_dispid_name(dispIdMember), dispIdMember, dispIdMember, wFlags, hres, hresult_name(hres));
	}
	return hres;
}
