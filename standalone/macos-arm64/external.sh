...
PINMAME_SHA=1cefca689edf9ff8c298678c7453ee7b5f5c84a4
...
if [ ! -f "../${CACHE_DIR}/${CACHE_NAME}.cache" ]; then
   ...
   cp -a build/libfreeimage.{dylib,*.dylib} ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cd ..
   touch "../${CACHE_DIR}/${CACHE_NAME}.cache"
fi

cp -a ../${CACHE_DIR}/${CACHE_NAME}/lib/libfreeimage.{dylib,*.dylib} ../external/lib
...
if [ ! -f "../${CACHE_DIR}/${CACHE_NAME}.cache" ]; then
   ...
   mkdir -p ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cp -a build/libpinmame.{dylib,*.dylib} ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cd ..
   touch "../${CACHE_DIR}/${CACHE_NAME}.cache"
fi

cp -r ../${CACHE_DIR}/${CACHE_NAME}/include/* ../external/include
cp -a ../${CACHE_DIR}/${CACHE_NAME}/lib/libpinmame.{dylib,*.dylib} ../external/lib
