...
PINMAME_SHA=6bb14f61bdaa12c9e92870677ff5661fa8d63ee2
...
cmake -DCMAKE_OSX_DEPLOYMENT_TARGET=13.0 -DCMAKE_BUILD_TYPE=Release -DUSE_OSXARM=ON -B build
cmake --build build -- -j${NUM_PROCS}
...
cmake -DPLATFORM=macos -DARCH=arm64 -DBUILD_STATIC=OFF -DCMAKE_BUILD_TYPE=Release -B build
cmake --build build -- -j${NUM_PROCS}
