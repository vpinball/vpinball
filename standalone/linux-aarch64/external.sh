...
if [ ! -f "../${CACHE_DIR}/${CACHE_NAME}.cache" ]; then
   ...
   cp -a build/libfreeimage.{so,so.*} ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cd ..
   touch "../${CACHE_DIR}/${CACHE_NAME}.cache"
fi

cp -a ../${CACHE_DIR}/${CACHE_NAME}/lib/libfreeimage.{so,so.*} ../external/lib
...
if [ ! -f "../${CACHE_DIR}/${CACHE_NAME}.cache" ]; then
   ...
   mkdir -p ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cp -a build/libpinmame.{so,so.*} ../../${CACHE_DIR}/${CACHE_NAME}/lib
   cd ..
   touch "../${CACHE_DIR}/${CACHE_NAME}.cache"
fi

cp -r ../${CACHE_DIR}/${CACHE_NAME}/include/* ../external/include
cp -a ../${CACHE_DIR}/${CACHE_NAME}/lib/libpinmame.{so,so.*} ../external/lib
