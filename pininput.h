...
public:
  ...
  void PushQueue(DIDEVICEOBJECTDATA* const data,
  ...
  // Speed: 0..1
  void PlayRumble(const float lowFrequencySpeed,
...
private:
  ...
  int m_joylflipkey, m_joyrflipkey, m_joylmagnasave, m_joyrmagnasave, m_joyplungerkey,
      m_joystartgamekey, m_joyexitgamekey, m_joyaddcreditkey;
  int m_joyaddcreditkey2, m_joyframecount, m_joyvolumeup, m_joyvolumedown, m_joylefttilt,
      m_joycentertilt, m_joyrighttilt, m_joypmbuyin;
  int m_joypmcoin3, m_joypmcoin4, m_joypmcoindoor, m_joypmcancel, m_joypmdown, m_joypmup,
      m_joypmenter, m_joydebugballs, m_joydebugger, m_joylockbar, m_joymechtilt;
  int m_joycustom1, m_joycustom1key, m_joycustom2, m_joycustom2key, m_joycustom3, m_joycustom3key,
      m_joycustom4, m_joycustom4key;
  int m_deadz;
  bool m_override_default_buttons, m_plunger_reverse, m_disable_esc, m_lr_axis_reverse,
      m_ud_axis_reverse;
