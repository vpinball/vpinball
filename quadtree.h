...
#endif
  void HitTestXRay(const Ball* const pball,
...
#ifndef USE_EMBREE
  void CreateNextLevel(const FRect& bounds,
                       const unsigned int level,
                       unsigned int level_empty); // FRect3D for an octree
