/*** Autogenerated by WIDL 7.10 from dlls/scrrun/scrrun.idl - Do not edit ***/
...
/*** IDictionary methods ***/
static FORCEINLINE HRESULT IDictionary_putref_Item(IDictionary* This,VARIANT *Key,VARIANT *pRetItem) {
    return This->lpVtbl->putref_Item(This,Key,pRetItem);
}
static FORCEINLINE HRESULT IDictionary_put_Item(IDictionary* This,VARIANT *Key,VARIANT *pRetItem) {
    return This->lpVtbl->put_Item(This,Key,pRetItem);
}
static FORCEINLINE HRESULT IDictionary_get_Item(IDictionary* This,VARIANT *Key,VARIANT *pRetItem) {
    return This->lpVtbl->get_Item(This,Key,pRetItem);
}
static FORCEINLINE HRESULT IDictionary_Add(IDictionary* This,VARIANT *Key,VARIANT *Item) {
    return This->lpVtbl->Add(This,Key,Item);
}
static FORCEINLINE HRESULT IDictionary_get_Count(IDictionary* This,LONG *pCount) {
    return This->lpVtbl->get_Count(This,pCount);
}
static FORCEINLINE HRESULT IDictionary_Exists(IDictionary* This,VARIANT *Key,VARIANT_BOOL *pExists) {
    return This->lpVtbl->Exists(This,Key,pExists);
}
static FORCEINLINE HRESULT IDictionary_Items(IDictionary* This,VARIANT *pItemsArray) {
    return This->lpVtbl->Items(This,pItemsArray);
}
static FORCEINLINE HRESULT IDictionary_put_Key(IDictionary* This,VARIANT *Key,VARIANT *rhs) {
    return This->lpVtbl->put_Key(This,Key,rhs);
}
static FORCEINLINE HRESULT IDictionary_Keys(IDictionary* This,VARIANT *pKeysArray) {
    return This->lpVtbl->Keys(This,pKeysArray);
}
static FORCEINLINE HRESULT IDictionary_Remove(IDictionary* This,VARIANT *Key) {
    return This->lpVtbl->Remove(This,Key);
}
static FORCEINLINE HRESULT IDictionary_RemoveAll(IDictionary* This) {
    return This->lpVtbl->RemoveAll(This);
}
static FORCEINLINE HRESULT IDictionary_put_CompareMode(IDictionary* This,CompareMethod pcomp) {
    return This->lpVtbl->put_CompareMode(This,pcomp);
}
static FORCEINLINE HRESULT IDictionary_get_CompareMode(IDictionary* This,CompareMethod *pcomp) {
    return This->lpVtbl->get_CompareMode(This,pcomp);
}
static FORCEINLINE HRESULT IDictionary__NewEnum(IDictionary* This,IUnknown **ppunk) {
    return This->lpVtbl->_NewEnum(This,ppunk);
}
static FORCEINLINE HRESULT IDictionary_get_HashVal(IDictionary* This,VARIANT *Key,VARIANT *HashVal) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IDrive_QueryInterface(IDrive* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IDrive_AddRef(IDrive* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IDrive_Release(IDrive* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IDrive_GetTypeInfoCount(IDrive* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IDrive_GetTypeInfo(IDrive* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IDrive_GetIDsOfNames(IDrive* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IDrive_Invoke(IDrive* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IDrive methods ***/
static FORCEINLINE HRESULT IDrive_get_Path(IDrive* This,BSTR *pbstrPath) {
    return This->lpVtbl->get_Path(This,pbstrPath);
}
static FORCEINLINE HRESULT IDrive_get_DriveLetter(IDrive* This,BSTR *pbstrLetter) {
    return This->lpVtbl->get_DriveLetter(This,pbstrLetter);
}
static FORCEINLINE HRESULT IDrive_get_ShareName(IDrive* This,BSTR *pbstrShareName) {
    return This->lpVtbl->get_ShareName(This,pbstrShareName);
}
static FORCEINLINE HRESULT IDrive_get_DriveType(IDrive* This,DriveTypeConst *pdt) {
    return This->lpVtbl->get_DriveType(This,pdt);
}
static FORCEINLINE HRESULT IDrive_get_RootFolder(IDrive* This,IFolder **ppfolder) {
    return This->lpVtbl->get_RootFolder(This,ppfolder);
}
static FORCEINLINE HRESULT IDrive_get_AvailableSpace(IDrive* This,VARIANT *pvarAvail) {
    return This->lpVtbl->get_AvailableSpace(This,pvarAvail);
}
static FORCEINLINE HRESULT IDrive_get_FreeSpace(IDrive* This,VARIANT *pvarFree) {
    return This->lpVtbl->get_FreeSpace(This,pvarFree);
}
static FORCEINLINE HRESULT IDrive_get_TotalSize(IDrive* This,VARIANT *pvarTotal) {
    return This->lpVtbl->get_TotalSize(This,pvarTotal);
}
static FORCEINLINE HRESULT IDrive_get_VolumeName(IDrive* This,BSTR *pbstrName) {
    return This->lpVtbl->get_VolumeName(This,pbstrName);
}
static FORCEINLINE HRESULT IDrive_put_VolumeName(IDrive* This,BSTR pbstrName) {
    return This->lpVtbl->put_VolumeName(This,pbstrName);
}
static FORCEINLINE HRESULT IDrive_get_FileSystem(IDrive* This,BSTR *pbstrFileSystem) {
    return This->lpVtbl->get_FileSystem(This,pbstrFileSystem);
}
static FORCEINLINE HRESULT IDrive_get_SerialNumber(IDrive* This,LONG *pulSerialNumber) {
    return This->lpVtbl->get_SerialNumber(This,pulSerialNumber);
}
static FORCEINLINE HRESULT IDrive_get_IsReady(IDrive* This,VARIANT_BOOL *pfReady) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IDriveCollection_QueryInterface(IDriveCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IDriveCollection_AddRef(IDriveCollection* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IDriveCollection_Release(IDriveCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IDriveCollection_GetTypeInfoCount(IDriveCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IDriveCollection_GetTypeInfo(IDriveCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IDriveCollection_GetIDsOfNames(IDriveCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IDriveCollection_Invoke(IDriveCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IDriveCollection methods ***/
static FORCEINLINE HRESULT IDriveCollection_get_Item(IDriveCollection* This,VARIANT Key,IDrive **ppdrive) {
    return This->lpVtbl->get_Item(This,Key,ppdrive);
}
static FORCEINLINE HRESULT IDriveCollection_get__NewEnum(IDriveCollection* This,IUnknown **ppenum) {
    return This->lpVtbl->get__NewEnum(This,ppenum);
}
static FORCEINLINE HRESULT IDriveCollection_get_Count(IDriveCollection* This,LONG *plCount) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ITextStream_QueryInterface(ITextStream* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ITextStream_AddRef(ITextStream* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ITextStream_Release(ITextStream* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT ITextStream_GetTypeInfoCount(ITextStream* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT ITextStream_GetTypeInfo(ITextStream* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT ITextStream_GetIDsOfNames(ITextStream* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT ITextStream_Invoke(ITextStream* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** ITextStream methods ***/
static FORCEINLINE HRESULT ITextStream_get_Line(ITextStream* This,LONG *Line) {
    return This->lpVtbl->get_Line(This,Line);
}
static FORCEINLINE HRESULT ITextStream_get_Column(ITextStream* This,LONG *Column) {
    return This->lpVtbl->get_Column(This,Column);
}
static FORCEINLINE HRESULT ITextStream_get_AtEndOfStream(ITextStream* This,VARIANT_BOOL *EOS) {
    return This->lpVtbl->get_AtEndOfStream(This,EOS);
}
static FORCEINLINE HRESULT ITextStream_get_AtEndOfLine(ITextStream* This,VARIANT_BOOL *EOL) {
    return This->lpVtbl->get_AtEndOfLine(This,EOL);
}
static FORCEINLINE HRESULT ITextStream_Read(ITextStream* This,LONG Characters,BSTR *Text) {
    return This->lpVtbl->Read(This,Characters,Text);
}
static FORCEINLINE HRESULT ITextStream_ReadLine(ITextStream* This,BSTR *Text) {
    return This->lpVtbl->ReadLine(This,Text);
}
static FORCEINLINE HRESULT ITextStream_ReadAll(ITextStream* This,BSTR *Text) {
    return This->lpVtbl->ReadAll(This,Text);
}
static FORCEINLINE HRESULT ITextStream_Write(ITextStream* This,BSTR Text) {
    return This->lpVtbl->Write(This,Text);
}
static FORCEINLINE HRESULT ITextStream_WriteLine(ITextStream* This,BSTR Text) {
    return This->lpVtbl->WriteLine(This,Text);
}
static FORCEINLINE HRESULT ITextStream_WriteBlankLines(ITextStream* This,LONG Lines) {
    return This->lpVtbl->WriteBlankLines(This,Lines);
}
static FORCEINLINE HRESULT ITextStream_Skip(ITextStream* This,LONG Characters) {
    return This->lpVtbl->Skip(This,Characters);
}
static FORCEINLINE HRESULT ITextStream_SkipLine(ITextStream* This) {
    return This->lpVtbl->SkipLine(This);
}
static FORCEINLINE HRESULT ITextStream_Close(ITextStream* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IFile_QueryInterface(IFile* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IFile_AddRef(IFile* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IFile_Release(IFile* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IFile_GetTypeInfoCount(IFile* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IFile_GetTypeInfo(IFile* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IFile_GetIDsOfNames(IFile* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IFile_Invoke(IFile* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFile methods ***/
static FORCEINLINE HRESULT IFile_get_Path(IFile* This,BSTR *pbstrPath) {
    return This->lpVtbl->get_Path(This,pbstrPath);
}
static FORCEINLINE HRESULT IFile_get_Name(IFile* This,BSTR *pbstrName) {
    return This->lpVtbl->get_Name(This,pbstrName);
}
static FORCEINLINE HRESULT IFile_put_Name(IFile* This,BSTR pbstrName) {
    return This->lpVtbl->put_Name(This,pbstrName);
}
static FORCEINLINE HRESULT IFile_get_ShortPath(IFile* This,BSTR *pbstrPath) {
    return This->lpVtbl->get_ShortPath(This,pbstrPath);
}
static FORCEINLINE HRESULT IFile_get_ShortName(IFile* This,BSTR *pbstrName) {
    return This->lpVtbl->get_ShortName(This,pbstrName);
}
static FORCEINLINE HRESULT IFile_get_Drive(IFile* This,IDrive **ppdrive) {
    return This->lpVtbl->get_Drive(This,ppdrive);
}
static FORCEINLINE HRESULT IFile_get_ParentFolder(IFile* This,IFolder **ppfolder) {
    return This->lpVtbl->get_ParentFolder(This,ppfolder);
}
static FORCEINLINE HRESULT IFile_get_Attributes(IFile* This,FileAttribute *pfa) {
    return This->lpVtbl->get_Attributes(This,pfa);
}
static FORCEINLINE HRESULT IFile_put_Attributes(IFile* This,FileAttribute pfa) {
    return This->lpVtbl->put_Attributes(This,pfa);
}
static FORCEINLINE HRESULT IFile_get_DateCreated(IFile* This,DATE *pdate) {
    return This->lpVtbl->get_DateCreated(This,pdate);
}
static FORCEINLINE HRESULT IFile_get_DateLastModified(IFile* This,DATE *pdate) {
    return This->lpVtbl->get_DateLastModified(This,pdate);
}
static FORCEINLINE HRESULT IFile_get_DateLastAccessed(IFile* This,DATE *pdate) {
    return This->lpVtbl->get_DateLastAccessed(This,pdate);
}
static FORCEINLINE HRESULT IFile_get_Size(IFile* This,VARIANT *pvarSize) {
    return This->lpVtbl->get_Size(This,pvarSize);
}
static FORCEINLINE HRESULT IFile_get_Type(IFile* This,BSTR *pbstrType) {
    return This->lpVtbl->get_Type(This,pbstrType);
}
static FORCEINLINE HRESULT IFile_Delete(IFile* This,VARIANT_BOOL Force) {
    return This->lpVtbl->Delete(This,Force);
}
static FORCEINLINE HRESULT IFile_Copy(IFile* This,BSTR Destination,VARIANT_BOOL OverWriteFiles) {
    return This->lpVtbl->Copy(This,Destination,OverWriteFiles);
}
static FORCEINLINE HRESULT IFile_Move(IFile* This,BSTR Destination) {
    return This->lpVtbl->Move(This,Destination);
}
static FORCEINLINE HRESULT IFile_OpenAsTextStream(IFile* This,IOMode IOMode,Tristate Format,ITextStream **ppts) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IFileSystem_QueryInterface(IFileSystem* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IFileSystem_AddRef(IFileSystem* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IFileSystem_Release(IFileSystem* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IFileSystem_GetTypeInfoCount(IFileSystem* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IFileSystem_GetTypeInfo(IFileSystem* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IFileSystem_GetIDsOfNames(IFileSystem* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IFileSystem_Invoke(IFileSystem* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFileSystem methods ***/
static FORCEINLINE HRESULT IFileSystem_get_Drives(IFileSystem* This,IDriveCollection **ppdrives) {
    return This->lpVtbl->get_Drives(This,ppdrives);
}
static FORCEINLINE HRESULT IFileSystem_BuildPath(IFileSystem* This,BSTR Path,BSTR Name,BSTR *pbstrResult) {
    return This->lpVtbl->BuildPath(This,Path,Name,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem_GetDriveName(IFileSystem* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetDriveName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem_GetParentFolderName(IFileSystem* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetParentFolderName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem_GetFileName(IFileSystem* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetFileName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem_GetBaseName(IFileSystem* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetBaseName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem_GetExtensionName(IFileSystem* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetExtensionName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem_GetAbsolutePathName(IFileSystem* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetAbsolutePathName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem_GetTempName(IFileSystem* This,BSTR *pbstrResult) {
    return This->lpVtbl->GetTempName(This,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem_DriveExists(IFileSystem* This,BSTR DriveSpec,VARIANT_BOOL *pfExists) {
    return This->lpVtbl->DriveExists(This,DriveSpec,pfExists);
}
static FORCEINLINE HRESULT IFileSystem_FileExists(IFileSystem* This,BSTR FileSpec,VARIANT_BOOL *pfExists) {
    return This->lpVtbl->FileExists(This,FileSpec,pfExists);
}
static FORCEINLINE HRESULT IFileSystem_FolderExists(IFileSystem* This,BSTR FolderSpec,VARIANT_BOOL *pfExists) {
    return This->lpVtbl->FolderExists(This,FolderSpec,pfExists);
}
static FORCEINLINE HRESULT IFileSystem_GetDrive(IFileSystem* This,BSTR DriveSpec,IDrive **ppdrive) {
    return This->lpVtbl->GetDrive(This,DriveSpec,ppdrive);
}
static FORCEINLINE HRESULT IFileSystem_GetFile(IFileSystem* This,BSTR FilePath,IFile **ppfile) {
    return This->lpVtbl->GetFile(This,FilePath,ppfile);
}
static FORCEINLINE HRESULT IFileSystem_GetFolder(IFileSystem* This,BSTR FolderPath,IFolder **ppfolder) {
    return This->lpVtbl->GetFolder(This,FolderPath,ppfolder);
}
static FORCEINLINE HRESULT IFileSystem_GetSpecialFolder(IFileSystem* This,SpecialFolderConst SpecialFolder,IFolder **ppfolder) {
    return This->lpVtbl->GetSpecialFolder(This,SpecialFolder,ppfolder);
}
static FORCEINLINE HRESULT IFileSystem_DeleteFile(IFileSystem* This,BSTR FileSpec,VARIANT_BOOL Force) {
    return This->lpVtbl->DeleteFile(This,FileSpec,Force);
}
static FORCEINLINE HRESULT IFileSystem_DeleteFolder(IFileSystem* This,BSTR FolderSpec,VARIANT_BOOL Force) {
    return This->lpVtbl->DeleteFolder(This,FolderSpec,Force);
}
static FORCEINLINE HRESULT IFileSystem_MoveFile(IFileSystem* This,BSTR Source,BSTR Destination) {
    return This->lpVtbl->MoveFile(This,Source,Destination);
}
static FORCEINLINE HRESULT IFileSystem_MoveFolder(IFileSystem* This,BSTR Source,BSTR Destination) {
    return This->lpVtbl->MoveFolder(This,Source,Destination);
}
static FORCEINLINE HRESULT IFileSystem_CopyFile(IFileSystem* This,BSTR Source,BSTR Destination,VARIANT_BOOL OverWriteFiles) {
    return This->lpVtbl->CopyFile(This,Source,Destination,OverWriteFiles);
}
static FORCEINLINE HRESULT IFileSystem_CopyFolder(IFileSystem* This,BSTR Source,BSTR Destination,VARIANT_BOOL OverWriteFiles) {
    return This->lpVtbl->CopyFolder(This,Source,Destination,OverWriteFiles);
}
static FORCEINLINE HRESULT IFileSystem_CreateFolder(IFileSystem* This,BSTR Path,IFolder **ppfolder) {
    return This->lpVtbl->CreateFolder(This,Path,ppfolder);
}
static FORCEINLINE HRESULT IFileSystem_CreateTextFile(IFileSystem* This,BSTR FileName,VARIANT_BOOL Overwrite,VARIANT_BOOL Unicode,ITextStream **ppts) {
    return This->lpVtbl->CreateTextFile(This,FileName,Overwrite,Unicode,ppts);
}
static FORCEINLINE HRESULT IFileSystem_OpenTextFile(IFileSystem* This,BSTR FileName,IOMode IOMode,VARIANT_BOOL Create,Tristate Format,ITextStream **ppts) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IFileCollection_QueryInterface(IFileCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IFileCollection_AddRef(IFileCollection* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IFileCollection_Release(IFileCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IFileCollection_GetTypeInfoCount(IFileCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IFileCollection_GetTypeInfo(IFileCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IFileCollection_GetIDsOfNames(IFileCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IFileCollection_Invoke(IFileCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFileCollection methods ***/
static FORCEINLINE HRESULT IFileCollection_get_Item(IFileCollection* This,VARIANT Key,IFile **ppfile) {
    return This->lpVtbl->get_Item(This,Key,ppfile);
}
static FORCEINLINE HRESULT IFileCollection_get__NewEnum(IFileCollection* This,IUnknown **ppenum) {
    return This->lpVtbl->get__NewEnum(This,ppenum);
}
static FORCEINLINE HRESULT IFileCollection_get_Count(IFileCollection* This,LONG *plCount) {
    return This->lpVtbl->get_Count(This,plCount);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IFolderCollection_QueryInterface(IFolderCollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IFolderCollection_AddRef(IFolderCollection* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IFolderCollection_Release(IFolderCollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IFolderCollection_GetTypeInfoCount(IFolderCollection* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IFolderCollection_GetTypeInfo(IFolderCollection* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IFolderCollection_GetIDsOfNames(IFolderCollection* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IFolderCollection_Invoke(IFolderCollection* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFolderCollection methods ***/
static FORCEINLINE HRESULT IFolderCollection_Add(IFolderCollection* This,BSTR Name,IFolder **ppfolder) {
    return This->lpVtbl->Add(This,Name,ppfolder);
}
static FORCEINLINE HRESULT IFolderCollection_get_Item(IFolderCollection* This,VARIANT Key,IFolder **ppfolder) {
    return This->lpVtbl->get_Item(This,Key,ppfolder);
}
static FORCEINLINE HRESULT IFolderCollection_get__NewEnum(IFolderCollection* This,IUnknown **ppenum) {
    return This->lpVtbl->get__NewEnum(This,ppenum);
}
static FORCEINLINE HRESULT IFolderCollection_get_Count(IFolderCollection* This,LONG *plCount) {
    return This->lpVtbl->get_Count(This,plCount);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IFolder_QueryInterface(IFolder* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IFolder_AddRef(IFolder* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IFolder_Release(IFolder* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IFolder_GetTypeInfoCount(IFolder* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IFolder_GetTypeInfo(IFolder* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IFolder_GetIDsOfNames(IFolder* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IFolder_Invoke(IFolder* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFolder methods ***/
static FORCEINLINE HRESULT IFolder_get_Path(IFolder* This,BSTR *pbstrPath) {
    return This->lpVtbl->get_Path(This,pbstrPath);
}
static FORCEINLINE HRESULT IFolder_get_Name(IFolder* This,BSTR *pbstrName) {
    return This->lpVtbl->get_Name(This,pbstrName);
}
static FORCEINLINE HRESULT IFolder_put_Name(IFolder* This,BSTR pbstrName) {
    return This->lpVtbl->put_Name(This,pbstrName);
}
static FORCEINLINE HRESULT IFolder_get_ShortPath(IFolder* This,BSTR *pbstrPath) {
    return This->lpVtbl->get_ShortPath(This,pbstrPath);
}
static FORCEINLINE HRESULT IFolder_get_ShortName(IFolder* This,BSTR *pbstrName) {
    return This->lpVtbl->get_ShortName(This,pbstrName);
}
static FORCEINLINE HRESULT IFolder_get_Drive(IFolder* This,IDrive **ppdrive) {
    return This->lpVtbl->get_Drive(This,ppdrive);
}
static FORCEINLINE HRESULT IFolder_get_ParentFolder(IFolder* This,IFolder **ppfolder) {
    return This->lpVtbl->get_ParentFolder(This,ppfolder);
}
static FORCEINLINE HRESULT IFolder_get_Attributes(IFolder* This,FileAttribute *pfa) {
    return This->lpVtbl->get_Attributes(This,pfa);
}
static FORCEINLINE HRESULT IFolder_put_Attributes(IFolder* This,FileAttribute pfa) {
    return This->lpVtbl->put_Attributes(This,pfa);
}
static FORCEINLINE HRESULT IFolder_get_DateCreated(IFolder* This,DATE *pdate) {
    return This->lpVtbl->get_DateCreated(This,pdate);
}
static FORCEINLINE HRESULT IFolder_get_DateLastModified(IFolder* This,DATE *pdate) {
    return This->lpVtbl->get_DateLastModified(This,pdate);
}
static FORCEINLINE HRESULT IFolder_get_DateLastAccessed(IFolder* This,DATE *pdate) {
    return This->lpVtbl->get_DateLastAccessed(This,pdate);
}
static FORCEINLINE HRESULT IFolder_get_Type(IFolder* This,BSTR *pbstrType) {
    return This->lpVtbl->get_Type(This,pbstrType);
}
static FORCEINLINE HRESULT IFolder_Delete(IFolder* This,VARIANT_BOOL Force) {
    return This->lpVtbl->Delete(This,Force);
}
static FORCEINLINE HRESULT IFolder_Copy(IFolder* This,BSTR Destination,VARIANT_BOOL OverWriteFiles) {
    return This->lpVtbl->Copy(This,Destination,OverWriteFiles);
}
static FORCEINLINE HRESULT IFolder_Move(IFolder* This,BSTR Destination) {
    return This->lpVtbl->Move(This,Destination);
}
static FORCEINLINE HRESULT IFolder_get_IsRootFolder(IFolder* This,VARIANT_BOOL *pfRootFolder) {
    return This->lpVtbl->get_IsRootFolder(This,pfRootFolder);
}
static FORCEINLINE HRESULT IFolder_get_Size(IFolder* This,VARIANT *pvarSize) {
    return This->lpVtbl->get_Size(This,pvarSize);
}
static FORCEINLINE HRESULT IFolder_get_SubFolders(IFolder* This,IFolderCollection **ppfolders) {
    return This->lpVtbl->get_SubFolders(This,ppfolders);
}
static FORCEINLINE HRESULT IFolder_get_Files(IFolder* This,IFileCollection **ppfiles) {
    return This->lpVtbl->get_Files(This,ppfiles);
}
static FORCEINLINE HRESULT IFolder_CreateTextFile(IFolder* This,BSTR FileName,VARIANT_BOOL Overwrite,VARIANT_BOOL Unicode,ITextStream **ppts) {
    return This->lpVtbl->CreateTextFile(This,FileName,Overwrite,Unicode,ppts);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IFileSystem3_QueryInterface(IFileSystem3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IFileSystem3_AddRef(IFileSystem3* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IFileSystem3_Release(IFileSystem3* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IFileSystem3_GetTypeInfoCount(IFileSystem3* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IFileSystem3_GetTypeInfo(IFileSystem3* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IFileSystem3_GetIDsOfNames(IFileSystem3* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IFileSystem3_Invoke(IFileSystem3* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IFileSystem methods ***/
static FORCEINLINE HRESULT IFileSystem3_get_Drives(IFileSystem3* This,IDriveCollection **ppdrives) {
    return This->lpVtbl->get_Drives(This,ppdrives);
}
static FORCEINLINE HRESULT IFileSystem3_BuildPath(IFileSystem3* This,BSTR Path,BSTR Name,BSTR *pbstrResult) {
    return This->lpVtbl->BuildPath(This,Path,Name,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem3_GetDriveName(IFileSystem3* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetDriveName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem3_GetParentFolderName(IFileSystem3* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetParentFolderName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem3_GetFileName(IFileSystem3* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetFileName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem3_GetBaseName(IFileSystem3* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetBaseName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem3_GetExtensionName(IFileSystem3* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetExtensionName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem3_GetAbsolutePathName(IFileSystem3* This,BSTR Path,BSTR *pbstrResult) {
    return This->lpVtbl->GetAbsolutePathName(This,Path,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem3_GetTempName(IFileSystem3* This,BSTR *pbstrResult) {
    return This->lpVtbl->GetTempName(This,pbstrResult);
}
static FORCEINLINE HRESULT IFileSystem3_DriveExists(IFileSystem3* This,BSTR DriveSpec,VARIANT_BOOL *pfExists) {
    return This->lpVtbl->DriveExists(This,DriveSpec,pfExists);
}
static FORCEINLINE HRESULT IFileSystem3_FileExists(IFileSystem3* This,BSTR FileSpec,VARIANT_BOOL *pfExists) {
    return This->lpVtbl->FileExists(This,FileSpec,pfExists);
}
static FORCEINLINE HRESULT IFileSystem3_FolderExists(IFileSystem3* This,BSTR FolderSpec,VARIANT_BOOL *pfExists) {
    return This->lpVtbl->FolderExists(This,FolderSpec,pfExists);
}
static FORCEINLINE HRESULT IFileSystem3_GetDrive(IFileSystem3* This,BSTR DriveSpec,IDrive **ppdrive) {
    return This->lpVtbl->GetDrive(This,DriveSpec,ppdrive);
}
static FORCEINLINE HRESULT IFileSystem3_GetFile(IFileSystem3* This,BSTR FilePath,IFile **ppfile) {
    return This->lpVtbl->GetFile(This,FilePath,ppfile);
}
static FORCEINLINE HRESULT IFileSystem3_GetFolder(IFileSystem3* This,BSTR FolderPath,IFolder **ppfolder) {
    return This->lpVtbl->GetFolder(This,FolderPath,ppfolder);
}
static FORCEINLINE HRESULT IFileSystem3_GetSpecialFolder(IFileSystem3* This,SpecialFolderConst SpecialFolder,IFolder **ppfolder) {
    return This->lpVtbl->GetSpecialFolder(This,SpecialFolder,ppfolder);
}
static FORCEINLINE HRESULT IFileSystem3_DeleteFile(IFileSystem3* This,BSTR FileSpec,VARIANT_BOOL Force) {
    return This->lpVtbl->DeleteFile(This,FileSpec,Force);
}
static FORCEINLINE HRESULT IFileSystem3_DeleteFolder(IFileSystem3* This,BSTR FolderSpec,VARIANT_BOOL Force) {
    return This->lpVtbl->DeleteFolder(This,FolderSpec,Force);
}
static FORCEINLINE HRESULT IFileSystem3_MoveFile(IFileSystem3* This,BSTR Source,BSTR Destination) {
    return This->lpVtbl->MoveFile(This,Source,Destination);
}
static FORCEINLINE HRESULT IFileSystem3_MoveFolder(IFileSystem3* This,BSTR Source,BSTR Destination) {
    return This->lpVtbl->MoveFolder(This,Source,Destination);
}
static FORCEINLINE HRESULT IFileSystem3_CopyFile(IFileSystem3* This,BSTR Source,BSTR Destination,VARIANT_BOOL OverWriteFiles) {
    return This->lpVtbl->CopyFile(This,Source,Destination,OverWriteFiles);
}
static FORCEINLINE HRESULT IFileSystem3_CopyFolder(IFileSystem3* This,BSTR Source,BSTR Destination,VARIANT_BOOL OverWriteFiles) {
    return This->lpVtbl->CopyFolder(This,Source,Destination,OverWriteFiles);
}
static FORCEINLINE HRESULT IFileSystem3_CreateFolder(IFileSystem3* This,BSTR Path,IFolder **ppfolder) {
    return This->lpVtbl->CreateFolder(This,Path,ppfolder);
}
static FORCEINLINE HRESULT IFileSystem3_CreateTextFile(IFileSystem3* This,BSTR FileName,VARIANT_BOOL Overwrite,VARIANT_BOOL Unicode,ITextStream **ppts) {
    return This->lpVtbl->CreateTextFile(This,FileName,Overwrite,Unicode,ppts);
}
static FORCEINLINE HRESULT IFileSystem3_OpenTextFile(IFileSystem3* This,BSTR FileName,IOMode IOMode,VARIANT_BOOL Create,Tristate Format,ITextStream **ppts) {
    return This->lpVtbl->OpenTextFile(This,FileName,IOMode,Create,Format,ppts);
}
/*** IFileSystem3 methods ***/
static FORCEINLINE HRESULT IFileSystem3_GetStandardStream(IFileSystem3* This,StandardStreamTypes StandardStreamType,VARIANT_BOOL Unicode,ITextStream **ppts) {
    return This->lpVtbl->GetStandardStream(This,StandardStreamType,Unicode,ppts);
}
static FORCEINLINE HRESULT IFileSystem3_GetFileVersion(IFileSystem3* This,BSTR FileName,BSTR *FileVersion) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IScriptEncoder_QueryInterface(IScriptEncoder* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IScriptEncoder_AddRef(IScriptEncoder* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IScriptEncoder_Release(IScriptEncoder* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IScriptEncoder_GetTypeInfoCount(IScriptEncoder* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IScriptEncoder_GetTypeInfo(IScriptEncoder* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IScriptEncoder_GetIDsOfNames(IScriptEncoder* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IScriptEncoder_Invoke(IScriptEncoder* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IScriptEncoder methods ***/
static FORCEINLINE HRESULT IScriptEncoder_EncodeScriptFile(IScriptEncoder* This,BSTR szExt,BSTR bstrStreamIn,LONG cFlags,BSTR bstrDefaultLang,BSTR *pbstrStreamOut) {
