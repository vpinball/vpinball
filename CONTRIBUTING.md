...
When contributing to a specific area, please also refer to the area-specific documentation when available.
...
Other licenses may impose conditions incompatible with VPX's distribution model. **"Source-available" is not 
...
a clang-format pass, a systematic rename, or a build system fix). In this case, a single larger PR is preferable
to many small ones.
...
else's idea, or are working in an unfamiliar subsystem — take extra care to test it rigorously and disclose this in
your PR description.
