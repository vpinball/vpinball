...
class Ramp : public IDispatchImpl<IRamp, &IID_IRamp, &LIBID_VPinballLib>,
...
public:
  ...
  {
    return (unsigned long long)(m_ptable->GetImage(m_d.m_szImage));
  }
...
private:
  ...
  Vertex2D* GetRampVertex(int& pcvertex,
  ...
  void CheckJoint(vector<HitObject*>& pvho,
  ...
  void AddWallLineSeg(vector<HitObject*>& pvho,
                      const Vertex2D& pv1,
                      const Vertex2D& pv2,
  ...
  void CreateWire(const int numRings,
