...
{
   ResetVPX();
   TestRender("test000-default-table.vpx", "test000-default-table", VPXBackends::ALL);
   ResetVPX();
}
...
TEST_CASE("Stereo top/bottom render")
{
   ...
   TestRender("test000-default-table.vpx", "test000-stereo-tb", VPXBackends::ALL_BUT_DX9);
   ResetVPX();
}
...
TEST_CASE("Stereo interleaved render")
{
   ...
   TestRender("test000-default-table.vpx", "test000-stereo-int", VPXBackends::ALL_BUT_DX9);
   ResetVPX();
}
...
TEST_CASE("Stereo side by side render")
{
   ...
   TestRender("test000-default-table.vpx", "test000-stereo-sbs", VPXBackends::ALL_BUT_DX9);
   ResetVPX();
}
...
TEST_CASE("Stereo anaglyph render")
{
   ...
   TestRender("test000-default-table.vpx", "test000-stereo-anaglyph", VPXBackends::ALL_BUT_DX9);
   ResetVPX();
}
