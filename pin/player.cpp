      ...
      if(!m_fCleanBlt || (overall_area >= FULLBLTAREA)) {
         ...
         if (m_ToggleDebugBalls)
         {
            ...
            if (m_DebugBalls)
            {
               ...
               /*ReturnCode =*/ m_pin3d.m_pd3dDevice->SetRenderState ( RenderDevice::ZENABLE, D3DZB_FALSE );
               /*ReturnCode =*/ m_pin3d.m_pd3dDevice->SetRenderState ( RenderDevice::ALPHABLENDENABLE, FALSE );
            }
            else
            {
               //HRESULT ReturnCode;
               // Restore the render state.
               /*ReturnCode =*/ m_pin3d.m_pd3dDevice->SetRenderState ( RenderDevice::ZENABLE, D3DZB_TRUE );
               /*ReturnCode =*/ m_pin3d.m_pd3dDevice->SetRenderState ( RenderDevice::ALPHABLENDENABLE, TRUE );
            }
...
void Player::InvalidateRect(RECT * const prc)
{
   ...
   //         has problems on some tables (like CFTBL,MonsterBash,Genie...)
