...
#define GetNudgeX() (((F32)m_curAccel_x[0]) * (F32)(2.0 / (JOYRANGEMX-JOYRANGEMN+1))) // Get the -1.0f to +1.0f values from joystick input tilt sensor / ushock
#define GetNudgeY() (((F32)m_curAccel_y[0]) * (F32)(2.0 / (JOYRANGEMX-JOYRANGEMN+1)))
