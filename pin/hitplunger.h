...
public:
        ...
        // Integrated mechanical position error.  We use this to bring
        // the simulated plunger position into alignment with the
        // mechanical plunger position.  We effectively act like the
        // two are connected by a spring with heavy friction damping;
        // this value amounts to the previous speed.
        float err_fil;
