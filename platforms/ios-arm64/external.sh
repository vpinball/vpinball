...
SDL3_EXPECTED_SHA="${SDL_SHA}-${SDL_IMAGE_SHA}-${SDL_TTF_SHA}-${SDL_MIXER_SHA}_001"
...
cp SDL3/SDL_mixer/build/libSDL3_mixer.a ../../../third-party/build-libs/ios-arm64
...
cp bass/libbass.dylib ../../../third-party/runtime-libs/ios-arm64