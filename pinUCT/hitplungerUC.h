class PlungerAnimObjectUC : public PlungerAnimObject
	{
public:
...
public:
	...
	HitPlungerUC(float x, float y, float x2, float pos, float zheight, Plunger* pPlunger);
	~HitPlungerUC() {}
	...
	PlungerAnimObjectUC m_plungeranim;
