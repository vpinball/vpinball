...
#define VP_VERSION_STRING_DIGITS \
  STR(VP_VERSION_MAJOR) STR(VP_VERSION_MINOR) STR(VP_VERSION_REV) ", 0"
#define VP_VERSION_STRING_POINTS \
  STR(VP_VERSION_MAJOR) "." STR(VP_VERSION_MINOR) "." STR(VP_VERSION_REV) ", 0"
#define VP_VERSION_STRING_COMMAS \
  STR(VP_VERSION_MAJOR) ", " STR(VP_VERSION_MINOR) ", " STR(VP_VERSION_REV) ", 0"
