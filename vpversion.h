...
#define VP_VERSION_STRING_POINTS_FULL STR(VP_VERSION_MAJOR) "." STR(VP_VERSION_MINOR) "." STR(VP_VERSION_REV) "." STR(GIT_REVISION) "." STR(GIT_SHA)
#define VP_VERSION_STRING_COMMAS_FULL STR(VP_VERSION_MAJOR) ", " STR(VP_VERSION_MINOR) ", " STR(VP_VERSION_REV) ", " STR(GIT_REVISION) ", " STR(GIT_SHA)
