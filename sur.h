...
public:
	...
	virtual void Polygon(Vertex2D *rgv, int count) = 0;
	virtual void PolygonImage(Vertex2D *rgv, int count, HBITMAP hbm, float left, float top, float right, float bottom, int bitmapwidth, int bitmapheight) = 0;
	virtual void Polyline(Vertex2D *rgv, int count) = 0;
