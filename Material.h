...
public:
   ...
   {
      mat.diffuse.a = a;
      mat.diffuse.r = (_color & 255) * (float)(1.0/255.0);
      mat.diffuse.g = (_color & 65280) * (float)(1.0/65280.0);
      mat.diffuse.b = (_color & 16711680) * (float)(1.0/16711680.0);
   }
   ...
   {
      mat.ambient.a = a;
      mat.ambient.r = (_color & 255) * (float)(1.0/255.0);
      mat.ambient.g = (_color & 65280) * (float)(1.0/65280.0);
      mat.ambient.b = (_color & 16711680) * (float)(1.0/16711680.0);
   }
   ...
   {
      setColor( a, (_color & 255) * (float)(1.0/255.0),
