...
void main()
{
   ...
   const ARRAY_BEGIN(float, offset, ARRAY_SIZE) 0.65275,2.42313,4.36403,6.30877,8.25848,10.21386,12.17512 ARRAY_END();
   const ARRAY_BEGIN(float, weight, ARRAY_SIZE) 0.20227,0.19003,0.08192,0.02181,0.00358,0.00036,0.00002 ARRAY_END();
   // org-version
