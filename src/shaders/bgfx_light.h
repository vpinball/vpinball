...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Build of vertex shader from vs_light.sc to vs_light with options: 
static const uint8_t vs_light_mtl[702] =
{
...
static const uint8_t vs_light_essl[6479] =
{
...
static const uint8_t vs_light_glsl[6823] =
{
...
static const uint8_t vs_light_dx11[487] =
{
	0x56, 0x53, 0x48, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x5e, 0xda, 0xa3, 0x5f, 0x01, 0x00, 0x10, 0x6d, // VSH.....^.._...m
	0x61, 0x74, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x56, 0x69, 0x65, 0x77, 0x50, 0x72, 0x6f, 0x6a, 0x04, // atWorldViewProj.
...
static const uint8_t vs_light_spv[995] =
{
	0x56, 0x53, 0x48, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x5e, 0xda, 0xa3, 0x5f, 0x01, 0x00, 0x10, 0x6d, // VSH.....^.._...m
	0x61, 0x74, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x56, 0x69, 0x65, 0x77, 0x50, 0x72, 0x6f, 0x6a, 0x04, // atWorldViewProj.
...
static const bgfx::EmbeddedShader vs_light = BGFX_EMBEDDED_SHADER(vs_light);

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Build of vertex shader from vs_light.sc to vs_light_st with options: STEREO
static const uint8_t vs_light_st_mtl[850] =
{
	0x56, 0x53, 0x48, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x5e, 0xda, 0xa3, 0x5f, 0x01, 0x00, 0x10, 0x6d, // VSH.....^.._...m
	0x61, 0x74, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x56, 0x69, 0x65, 0x77, 0x50, 0x72, 0x6f, 0x6a, 0x04, // atWorldViewProj.
...
static const uint8_t vs_light_st_essl[6523] =
{
	...
	0x69, 0x6f, 0x6e, 0x2c, 0x20, 0x31, 0x2e, 0x30, 0x29, 0x29, 0x20, 0x29, 0x3b, 0x0a, 0x67, 0x6c, // ion, 1.0)) );.gl
	0x5f, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x20, 0x3d, 0x20, 0x67, 0x6c, 0x5f, 0x49, 0x6e, 0x73, 0x74, // _Layer = gl_Inst
	0x61, 0x6e, 0x63, 0x65, 0x49, 0x44, 0x3b, 0x0a, 0x7d, 0x0a, 0x00,                               // anceID;.}..
};
static const uint8_t vs_light_st_glsl[6867] =
{
	...
	0x6e, 0x2e, 0x78, 0x79, 0x7a, 0x3b, 0x0a, 0x67, 0x6c, 0x5f, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, // n.xyz;.gl_Positi
	...
	0x61, 0x6e, 0x63, 0x65, 0x49, 0x44, 0x5d, 0x29, 0x20, 0x2a, 0x20, 0x28, 0x76, 0x65, 0x63, 0x34, // anceID]) * (vec4
	0x28, 0x61, 0x5f, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2c, 0x20, 0x31, 0x2e, 0x30, // (a_position, 1.0
	0x29, 0x29, 0x20, 0x29, 0x3b, 0x0a, 0x67, 0x6c, 0x5f, 0x4c, 0x61, 0x79, 0x65, 0x72, 0x20, 0x3d, // )) );.gl_Layer =
	0x20, 0x67, 0x6c, 0x5f, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x44, 0x3b, 0x0a, //  gl_InstanceID;.
	0x7d, 0x0a, 0x00,                                                                               // }..
};
static const uint8_t vs_light_st_dx11[699] =
{
	0x56, 0x53, 0x48, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x5e, 0xda, 0xa3, 0x5f, 0x01, 0x00, 0x10, 0x6d, // VSH.....^.._...m
	0x61, 0x74, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x56, 0x69, 0x65, 0x77, 0x50, 0x72, 0x6f, 0x6a, 0x04, // atWorldViewProj.
...
static const uint8_t vs_light_st_spv[1305] =
{
	0x56, 0x53, 0x48, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x5e, 0xda, 0xa3, 0x5f, 0x01, 0x00, 0x10, 0x6d, // VSH.....^.._...m
	0x61, 0x74, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x56, 0x69, 0x65, 0x77, 0x50, 0x72, 0x6f, 0x6a, 0x04, // atWorldViewProj.
	...
	0x77, 0x50, 0x72, 0x6f, 0x6a, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x03, 0x00, 0x27, 0x00, 0x00, // wProj........'..
	...
	0x79, 0x65, 0x72, 0x00, 0x00, 0x47, 0x00, 0x04, 0x00, 0x24, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, // yer..G...$......
	0x00, 0x40, 0x00, 0x00, 0x00, 0x48, 0x00, 0x04, 0x00, 0x25, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // .@...H...%......
	...
	0x00, 0x1b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2b, 0x00, 0x04, 0x00, 0x06, 0x00, 0x00, // .........+......
	0x00, 0x1d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x3f, 0x18, 0x00, 0x04, 0x00, 0x22, 0x00, 0x00, // ........?...."..
	0x00, 0x0b, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x2b, 0x00, 0x04, 0x00, 0x09, 0x00, 0x00, // .........+......
	0x00, 0x23, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x1c, 0x00, 0x04, 0x00, 0x24, 0x00, 0x00, // .#...........$..
	0x00, 0x22, 0x00, 0x00, 0x00, 0x23, 0x00, 0x00, 0x00, 0x1e, 0x00, 0x03, 0x00, 0x25, 0x00, 0x00, // ."...#.......%..
	...
	0x00, 0x22, 0x00, 0x00, 0x00, 0x20, 0x00, 0x04, 0x00, 0x36, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, // ."... ...6......
	...
	0x00, 0x51, 0x00, 0x05, 0x00, 0x06, 0x00, 0x00, 0x00, 0x67, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, // .Q.......g...8..
	0x00, 0x00, 0x00, 0x00, 0x00, 0x51, 0x00, 0x05, 0x00, 0x06, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, // .....Q.......h..
	0x00, 0x38, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x51, 0x00, 0x05, 0x00, 0x06, 0x00, 0x00, // .8.......Q......
	0x00, 0x69, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x50, 0x00, 0x07, // .i...8.......P..
	0x00, 0x0b, 0x00, 0x00, 0x00, 0x6a, 0x00, 0x00, 0x00, 0x67, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, // .....j...g...h..
	0x00, 0x69, 0x00, 0x00, 0x00, 0x1d, 0x00, 0x00, 0x00, 0x41, 0x00, 0x06, 0x00, 0x29, 0x00, 0x00, // .i.......A...)..
	0x00, 0x6c, 0x00, 0x00, 0x00, 0x27, 0x00, 0x00, 0x00, 0x1b, 0x00, 0x00, 0x00, 0x3c, 0x00, 0x00, // .l...'.......<..
	0x00, 0x3d, 0x00, 0x04, 0x00, 0x22, 0x00, 0x00, 0x00, 0x6d, 0x00, 0x00, 0x00, 0x6c, 0x00, 0x00, // .=..."...m...l..
	0x00, 0x90, 0x00, 0x05, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x6e, 0x00, 0x00, 0x00, 0x6a, 0x00, 0x00, // .........n...j..
	0x00, 0x6d, 0x00, 0x00, 0x00, 0x3e, 0x00, 0x03, 0x00, 0x44, 0x00, 0x00, 0x00, 0x6e, 0x00, 0x00, // .m...>...D...n..
...
static const bgfx::EmbeddedShader vs_light_st = BGFX_EMBEDDED_SHADER(vs_light_st);

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Build of fragment shader from fs_light.sc to fs_light_noshadow with options: NOSHADOW
static const uint8_t fs_light_noshadow_mtl[1137] =
{
...
static const uint8_t fs_light_noshadow_essl[7922] =
{
...
static const uint8_t fs_light_noshadow_glsl[8290] =
{
...
static const uint8_t fs_light_noshadow_dx11[916] =
{
	0x46, 0x53, 0x48, 0x0b, 0x5e, 0xda, 0xa3, 0x5f, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x14, 0x6c, // FSH.^.._.......l
...
static const uint8_t fs_light_noshadow_spv[1952] =
{
	0x46, 0x53, 0x48, 0x0b, 0x5e, 0xda, 0xa3, 0x5f, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x14, 0x6c, // FSH.^.._.......l
	0x69, 0x67, 0x68, 0x74, 0x43, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x5f, 0x6d, 0x61, 0x78, 0x52, 0x61, // ightCenter_maxRa
	0x6e, 0x67, 0x65, 0x12, 0x01, 0x20, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x19, 0x6c, 0x69, // nge.. ........li
...
static const bgfx::EmbeddedShader fs_light_noshadow = BGFX_EMBEDDED_SHADER(fs_light_noshadow);

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Build of fragment shader from fs_light.sc to fs_light_ballshadow with options: BALLSHADOW
static const uint8_t fs_light_ballshadow_mtl[2847] =
{
...
static const uint8_t fs_light_ballshadow_essl[8016] =
{
...
static const uint8_t fs_light_ballshadow_glsl[8382] =
{
...
static const uint8_t fs_light_ballshadow_dx11[2180] =
{
	0x46, 0x53, 0x48, 0x0b, 0x5e, 0xda, 0xa3, 0x5f, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x05, 0x62, // FSH.^.._.......b
	0x61, 0x6c, 0x6c, 0x73, 0x12, 0x08, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x6c, // alls...........l
	0x69, 0x67, 0x68, 0x74, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x73, // ightColor_intens
...
static const uint8_t fs_light_ballshadow_spv[3680] =
{
	0x46, 0x53, 0x48, 0x0b, 0x5e, 0xda, 0xa3, 0x5f, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x05, 0x62, // FSH.^.._.......b
	0x61, 0x6c, 0x6c, 0x73, 0x12, 0x08, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x6c, // alls...........l
	0x69, 0x67, 0x68, 0x74, 0x43, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x5f, 0x6d, 0x61, 0x78, 0x52, 0x61, // ightCenter_maxRa
...
static const bgfx::EmbeddedShader fs_light_ballshadow = BGFX_EMBEDDED_SHADER(fs_light_ballshadow);
