...
//
// The ids the core and table parts need live apart, so that they do not have to pull all of the below in.
// Keep this include if the Visual Studio resource editor ever drops it when regenerating this file
