...
void TableLightsProperty::UpdateProperties(const int dispid)
{
   ...
   case IDC_LIGHTEMISSIONSCALE: CHECK_UPDATE_ITEM(table->m_lightEmissionScale, PropertyDialog::GetFloatTextbox(m_lightEmissionScaleEdit), table); break;
   case IDC_LIGHTHEIGHT: CHECK_UPDATE_ITEM(table->m_lightHeight, PropertyDialog::GetFloatTextbox(m_lightHeightEdit), table); break;
   case IDC_LIGHTRANGE: CHECK_UPDATE_ITEM(table->m_lightRange, PropertyDialog::GetFloatTextbox(m_lightRangeEdit), table); break;
   case DISPID_Image7: CHECK_UPDATE_COMBO_TEXT_STRING(table->m_envImage, m_envEmissionImageCombo, table); break;
   case IDC_ENVEMISSIONSCALE: CHECK_UPDATE_ITEM(table->m_envEmissionScale, PropertyDialog::GetFloatTextbox(m_envEmissionScaleEdit), table); break;
   case IDC_SCENELIGHTSCALE: CHECK_UPDATE_ITEM(table->m_globalEmissionScale, PropertyDialog::GetFloatTextbox(m_sceneLightScaleEdit), table); break;
   default: break;
   }
