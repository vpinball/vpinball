...
BOOL BumperVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_capMaterialCombo, CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_bumpBaseMaterialCombo, CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_skirtMaterialCombo, CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringMaterialCombo, CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_radiusEdit, CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_heightScaleEdit, CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_orientationEdit, CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringSpeedEdit, CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringDropOffsetEdit, CResizer::topleft, RD_STRETCH_WIDTH);
