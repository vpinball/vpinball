...
BOOL BumperVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_capMaterialCombo.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_bumpBaseMaterialCombo.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_skirtMaterialCombo.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringMaterialCombo.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_radiusEdit.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_heightScaleEdit.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_orientationEdit.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringSpeedEdit.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringDropOffsetEdit.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hCapVisibleCheck, CResizer::topleft, 0);
    m_resizer.AddChild(m_hBaseVisibleCheck, CResizer::topleft, 0);
    m_resizer.AddChild(m_hRingVisibleCheck, CResizer::topleft, 0);
    m_resizer.AddChild(m_hSkirtVisibleCheck, CResizer::topleft, 0);
    ...
    m_resizer.AddChild(m_surfaceCombo.GetHwnd(), CResizer::topleft, RD_STRETCH_WIDTH);
