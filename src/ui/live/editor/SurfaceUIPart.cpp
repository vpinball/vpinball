...
SurfaceUIPart::TransformMask SurfaceUIPart::GetTransform(Matrix3D& transform) { return GetCurveTransform(transform, 0.5f * (m_part->m_d.m_heightbottom + m_part->m_d.m_heighttop)); }
