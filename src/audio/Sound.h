...
public:
   ...
   static PinSound* CreateFromFile(const string& filename);
   static PinSound* CreateFromStream(IStream* pstm, const int LoadFileVersion);
   ...
   // Cached sound players for this sound, kept here for simplicity and performance but only to be used by audio renderer
   vector<class SoundPlayer*> m_soundPlayers;
