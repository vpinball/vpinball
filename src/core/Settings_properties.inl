...
PropFloat(Player, RumblePlunger, "Plunger Rumble"s, "Strength of the rumble played when the plunger bounces, scaled by its speed (0 disables it)"s, 0.f, 3.f, 1.f);
PropFloat(Player, RumbleFlipperButton, "Flipper Button Rumble"s, "Strength of the short buzz played when a flipper button is pressed (0 disables it)"s, 0.f, 3.f, 1.f);
