...
PropBool(Player, EnableHardwareVisualNudge, "Enable Hardware Visual Nudge"s, "Enable/Disable screen shaking when using hardware sensors"s, false);
PropFloat(Player, HardwareVisualNudgeThreshold, "Hardware Visual Nudge Threshold"s, "The threshold of when to apply visual nudge when using hardware sensors"s, 0.015f, 0.05f, 0.f);
PropFloat(Player, HardwareVisualNudgeScale, "Hardware Visual Nudge Scale"s, "The scale of the shaking when using hardware sensors"s, 0.25f, 1.f, 0.f);
