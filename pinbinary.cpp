...
{
  const HANDLE hFile = CreateFile(szFileName.c_str(), GENERIC_READ, FILE_SHARE_READ, nullptr,
...
{
  const HANDLE hFile = CreateFile(szfilename.c_str(), GENERIC_WRITE, FILE_SHARE_READ, nullptr,
