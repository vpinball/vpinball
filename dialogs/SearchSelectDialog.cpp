...
BOOL SearchSelectDialog::OnInitDialog()
{
  ...
  m_resizer.AddChild(GetDlgItem(IDC_ELEMENT_LIST).GetHwnd(), topleft,
  ...
  LoadPosition();
  SetFocus();
  ListView_SetItemState(m_hElementList, 0, LVIS_SELECTED | LVIS_FOCUSED,
...
INT_PTR SearchSelectDialog::DialogProc(UINT uMsg, WPARAM wParam, LPARAM lParam)
{
  ...
  switch (uMsg)
  {
    ...
    case WM_SIZE:
    {
      ...
      ::SetWindowPos(GetDlgItem(IDCANCEL).GetHwnd(), nullptr, 6 + buttonWidth + 50, buttonY,
...
void SearchSelectDialog::AddSearchItemToList(IEditable* const piedit, int idx)
{
  ...
  switch (piedit->GetItemType())
  {
    case eItemSurface:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 7,
                           sur->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8, sur->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           sur->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*sur->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           sur->StaticRendering() ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 12,
                           /*sur->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo*/ "N/A");
      break;
    }
    case eItemRamp:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           ramp->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           ramp->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           ramp->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ...
      ListView_SetItemText(
          m_hElementList, idx, 11,
          ramp->isHabitrail() /*&& !ramp->m_ptable->GetMaterial(ramp->m_d.m_szMaterial)->m_bOpacityActive*/
              ? usedStringYes
              : usedStringNo); //!!
      ListView_SetItemText(m_hElementList, idx, 12,
                           ramp->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemFlasher:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           /*flasher->m_d.m_collidable ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 8,
                           flasher->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           flasher->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      char textBuf[MAXNAMEBUFFER];
      sprintf_s(textBuf, "%.03f", flasher->m_d.m_depthBias);
      ListView_SetItemText(m_hElementList, idx, 10, textBuf);
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*flasher->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(
          m_hElementList, idx, 12,
          /*flasher->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo*/ "N/A");
      break;
    }
    case eItemRubber:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           rubber->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           rubber->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           rubber->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*rubber->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           rubber->m_d.m_staticRendering ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 12,
                           rubber->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemSpinner:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           spinner->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           spinner->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           spinner->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*spinner->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*spinner->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           spinner->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemKicker:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           kicker->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           kicker->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           kicker->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*kicker->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*kicker->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           kicker->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemLight:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           light->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           light->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           light->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      char textBuf[MAXNAMEBUFFER];
      sprintf_s(textBuf, "%.03f", light->m_d.m_depthBias);
      ListView_SetItemText(m_hElementList, idx, 10, textBuf);
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*light->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           light->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemBumper:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           bumper->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           bumper->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           bumper->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*bumper->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*bumper->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           bumper->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemFlipper:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           flipper->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           flipper->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           flipper->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*flipper->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*flipper->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           flipper->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemGate:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           gate->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           gate->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           gate->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*gate->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*gate->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           gate->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemTrigger:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           trigger->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           trigger->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           trigger->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*trigger->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*trigger->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           trigger->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemTimer:
    {
    ...
    case eItemPlunger:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           plunger->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           plunger->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           plunger->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 10, /*plunger->m_d.m_depthBias*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*plunger->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           plunger->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemDispReel:
    {
    ...
    case eItemPrimitive:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           primitive->m_d.m_collidable &&
                                   (!primitive->m_d.m_toy || primitive->m_d.m_useAsPlayfield)
                               ? usedStringYes
                               : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           primitive->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           primitive->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      char textBuf[MAXNAMEBUFFER];
      sprintf_s(textBuf, "%.03f", primitive->m_d.m_depthBias);
      ListView_SetItemText(m_hElementList, idx, 10, textBuf);
      ListView_SetItemText(m_hElementList, idx, 11,
                           primitive->m_d.m_staticRendering ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 12,
                           primitive->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemHitTarget:
    {
      ...
      ListView_SetItemText(m_hElementList, idx, 6, "N/A"); //!!
      ListView_SetItemText(m_hElementList, idx, 7,
                           hitTarget->m_d.m_collidable ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 8,
                           hitTarget->m_isVisible ? usedStringYes : usedStringNo);
      ListView_SetItemText(m_hElementList, idx, 9,
                           hitTarget->m_d.m_tdr.m_TimerEnabled ? usedStringYes : usedStringNo);
      char textBuf[MAXNAMEBUFFER];
      sprintf_s(textBuf, "%.03f", hitTarget->m_d.m_depthBias);
      ListView_SetItemText(m_hElementList, idx, 10, textBuf);
      ListView_SetItemText(m_hElementList, idx, 11,
                           /*hitTarget->StaticRendering() ? usedStringYes : usedStringNo*/ "N/A");
      ListView_SetItemText(m_hElementList, idx, 12,
                           hitTarget->m_d.m_reflectionEnabled ? usedStringYes : usedStringNo);
      break;
    }
    case eItemDecal:
    {
