...
BOOL TablePhysicsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_hFilterMechanicalPlungerCheck, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_importSetButton, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_exportSetButton, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_gravityConstantEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_playfieldFrictionEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_playfieldElasticityFalloffEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_playfieldScatterEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_defaultScatterEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_nudgeTimeEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_physicsLoopEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_mechPlungerAdjEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_tableWidthEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_tableHeightEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_topGlassHeightEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_tableFieldHeightEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_minSlopeEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_maxSlopeEdit, center, RD_STRETCH_WIDTH);
    return TRUE;
}
