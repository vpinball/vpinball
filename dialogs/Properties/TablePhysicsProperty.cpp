...
BOOL TablePhysicsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_hFilterMechanicalPlungerCheck, leftcenter, 0);
    m_resizer.AddChild(m_importSetButton, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_exportSetButton, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_gravityConstantEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_playfieldFrictionEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_playfieldElasticityFalloffEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_playfieldScatterEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_defaultScatterEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_nudgeTimeEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_physicsLoopEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_mechPlungerAdjEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_tableWidthEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_tableHeightEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_topGlassHeightEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_tableFieldHeightEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_minSlopeEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_maxSlopeEdit, leftcenter, RD_STRETCH_WIDTH);
    return TRUE;
}
