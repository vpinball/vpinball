...
BOOL SpinnerVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_hShowBracketCheck, leftcenter, 0);
    ...
    m_resizer.AddChild(m_angleMaxEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_angleMinEdit, leftcenter, RD_STRETCH_WIDTH);
