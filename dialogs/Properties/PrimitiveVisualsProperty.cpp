...
BOOL PrimitiveVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_hDisplayImageCheck, leftcenter, 0);
    m_resizer.AddChild(m_hObjectSpaceCheck, leftcenter, 0);
    m_resizer.AddChild(m_hVisibleCheck, leftcenter, 0);
    m_resizer.AddChild(m_hReflectionEnabledCheck, leftcenter, 0);
    m_resizer.AddChild(m_hRenderBackfacingCheck, leftcenter, 0);
    m_resizer.AddChild(m_hStaticRenderingCheck, leftcenter, 0);
    m_resizer.AddChild(m_imageCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_normalMapCombo, leftcenter, RD_STRETCH_WIDTH);
    ...
    m_resizer.AddChild(m_legacySidesEdit, leftcenter, 0);
    m_resizer.AddChild(m_edgeFactorUIEdit, rightcenter, RD_STRETCH_WIDTH);
