...
BOOL RampVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(GetDlgItem(IDC_STATIC13), leftcenter, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC14), leftcenter, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
    ...
    m_resizer.AddChild(m_topHeightEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_bottomHeightEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_topWidthEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_bottomWidthEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_leftWallEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_rightWallEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_diameterEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_distanceXEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_distanceYEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hReflectionEnabledCheck, leftcenter, 0);
    m_resizer.AddChild(m_hVisibleCheck, leftcenter, 0);
    m_resizer.AddChild(m_hApplyImageToWallCheck, leftcenter, 0);
