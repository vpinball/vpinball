...
BOOL RubberVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_thicknessEdit, center, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
    ...
    m_resizer.AddChild(m_hShowInEditorCheck, center, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
