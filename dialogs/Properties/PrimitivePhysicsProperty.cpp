...
BOOL PrimitivePhysicsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_frictionEdit, leftcenter, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
    ...
    m_resizer.AddChild(m_hToyCheck, leftcenter, 0);
    m_resizer.AddChild(m_hCollidableCheck, leftcenter, 0);
    m_resizer.AddChild(m_hOverwritePhysicsCheck, leftcenter, 0);
    m_resizer.AddChild(m_reducePolyEdit, leftcenter, RD_STRETCH_WIDTH);
