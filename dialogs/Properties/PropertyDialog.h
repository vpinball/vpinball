...
{
public:
  BasePropertyDialog(const int id, const VectorProtected<ISelect>* pvsel)
    : CDialog(id), m_pvsel(pvsel)
  {
...
public:
  ...
  virtual void DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
  {
    ...
    dc.DrawEdge(rect, (state & ODS_SELECTED) ? EDGE_SUNKEN : EDGE_RAISED,
                BF_RECT); // if pressed draw sunken, otherwise raised face
...
public:
  ...
  static void UpdateTextureComboBox(const vector<Texture*>& contentList,
                                    const CComboBox& combo,
                                    const string& selectName);
  static void UpdateComboBox(const vector<string>& contentList,
                             const CComboBox& combo,
                             const string& selectName);
  static void UpdateMaterialComboBox(const vector<Material*>& contentList,
                                     const CComboBox& combo,
                                     const string& selectName);
  static void UpdateSurfaceComboBox(const PinTable* const ptable,
                                    const CComboBox& combo,
                                    const string& selectName);
  static void UpdateSoundComboBox(const PinTable* const ptable,
                                  const CComboBox& combo,
                                  const string& selectName);
  static void UpdateCollectionComboBox(const PinTable* const ptable,
                                       const CComboBox& combo,
