...
void PropertyDialog::CreateTabs(VectorProtected<ISelect>& pvsel)
{
  ...
  switch (psel->GetItemType())
  {
    case eItemTable:
    {
      if (g_pvp->m_backglassView)
      {
        ...
        m_tabs[0] = static_cast<BasePropertyDialog*>(
            m_tab.AddTabPage(new BackglassVisualsProperty(&pvsel), _T("Visuals")));
      ...
      else
      {
        ...
        m_tabs[0] = static_cast<BasePropertyDialog*>(
            m_tab.AddTabPage(new TableCustomProperty(&pvsel), _T("User")));
        m_tabs[1] = static_cast<BasePropertyDialog*>(
            m_tab.AddTabPage(new TableVisualsProperty(&pvsel), _T("Visuals")));
        m_tabs[2] = static_cast<BasePropertyDialog*>(
            m_tab.AddTabPage(new TablePhysicsProperty(&pvsel), _T("Physics")));
    ...
    case eItemSurface:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new WallVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new WallPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
    ...
    case eItemGate:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new GateVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new GatePhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemRamp:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new RampVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new RampPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemFlipper:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new FlipperVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new FlipperPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemPlunger:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new PlungerVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new PlungerPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemBumper:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new BumperVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new BumperPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemSpinner:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new SpinnerVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new SpinnerPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemTrigger:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TriggerVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TriggerPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemLight:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new LightVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new LightStatesProperty(&pvsel), _T("States")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemKicker:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new KickerVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new KickerPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemHitTarget:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new HitTargetVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new HitTargetPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemTextbox:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TextboxVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemDispReel:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new DispreelVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new DispreelStateProperty(&pvsel), _T("States")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemLightSeq:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new LightseqStatesProperty(&pvsel), _T("States")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
    ...
    case eItemPrimitive:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new PrimitiveVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new PrimitivePositionProperty(&pvsel), _T("Position")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
    ...
    case eItemFlasher:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new FlasherVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
    ...
    case eItemRubber:
    {
      ...
      m_tabs[0] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new RubberVisualsProperty(&pvsel), _T("Visuals")));
      m_tabs[1] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new RubberPhysicsProperty(&pvsel), _T("Physics")));
      m_tabs[2] = static_cast<BasePropertyDialog*>(
          m_tab.AddTabPage(new TimerProperty(&pvsel), _T("Timer")));
      if (m_tab.m_activeTabText == CString("Visuals"))
      {
...
void PropertyDialog::UpdateTextureComboBox(const vector<Texture*>& contentList,
...
void PropertyDialog::UpdateMaterialComboBox(const vector<Material*>& contentList,
                                            const CComboBox& combo,
                                            const std::string& selectName)
{
  bool matFound = false;
...
void PropertyDialog::UpdateSurfaceComboBox(const PinTable* const ptable,
                                           const CComboBox& combo,
                                           const string& selectName)
{
  ...
  if (combo.FindStringExact(1, selectName.c_str()) == CB_ERR)
  {
    ...
    {
      if (ptable->m_vedit[i]->GetItemType() == eItemSurface ||
          (ptable->m_vedit[i]->GetItemType() == eItemRamp) ||
          //!! **************** warning **********************
...
void PropertyDialog::UpdateSoundComboBox(const PinTable* const ptable,
                                         const CComboBox& combo,
                                         const string& selectName)
{
  if (combo.FindStringExact(1, selectName.c_str()) == CB_ERR)
...
void PropertyDialog::UpdateCollectionComboBox(const PinTable* const ptable,
                                              const CComboBox& combo,
                                              const char* selectName)
{
  if (combo.FindStringExact(1, selectName) == CB_ERR)
  {
    ...
    {
      char szT[sizeof(ptable->m_vcollection[i].m_wzName) /
               sizeof(ptable->m_vcollection[i].m_wzName[0])];
      WideCharToMultiByteNull(CP_ACP, 0, ptable->m_vcollection[i].m_wzName, -1, szT, sizeof(szT),
                              nullptr, nullptr);
      combo.AddString(szT);
    }
  }
...
void PropertyDialog::UpdateComboBox(const vector<string>& contentList,
                                    const CComboBox& combo,
                                    const string& selectName)
{
  bool strFound = false;
...
BOOL PropertyDialog::OnCommand(WPARAM wParam, LPARAM lParam)
{
  ...
  switch (HIWORD(wParam))
  {
    ...
    case BN_CLICKED:
    {
      ...
      {
        m_tabs[0]->m_pvsel->ElementAt(0)->GetIEditable()->SetName(
            string(m_nameEdit.GetWindowText()));
        m_nameEdit.SetWindowText(m_tabs[0]
                                     ->m_pvsel->ElementAt(0)
                                     ->GetIEditable()
                                     ->GetName()); // set it again in case it was truncated
      }
      return TRUE;
    }
  }
...
TimerProperty::TimerProperty(const VectorProtected<ISelect>* pvsel)
  : BasePropertyDialog(IDD_PROPTIMER, pvsel)
{
  ...
  for (int i = 0; i < m_pvsel->size(); i++)
  {
    ...
    switch (m_pvsel->ElementAt(i)->GetItemType())
    {
      case eItemSurface:
      {
        ...
        wall->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemLight:
      {
        ...
        light->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemFlasher:
      {
        ...
        flash->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemRubber:
      {
        ...
        rubber->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemBumper:
      {
        ...
        bumper->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemPlunger:
      {
        ...
        plunger->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemSpinner:
      {
        ...
        spinner->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemTimer:
      {
        ...
        timer->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemHitTarget:
      {
        ...
        target->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemTrigger:
      {
        ...
        trigger->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemKicker:
      {
        ...
        kicker->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemRamp:
      ...
      case eItemFlipper:
      {
        ...
        flipper->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      case eItemGate:
      ...
      case eItemLightSeq:
      {
        ...
        lightseq->m_d.m_tdr.m_TimerEnabled =
            PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), 900));
        break;
      }
      default:
  ...
  for (int i = 0; i < m_pvsel->size(); i++)
  {
    ...
    switch (m_pvsel->ElementAt(i)->GetItemType())
    {
      case eItemSurface:
      {
        ...
        /*TODO: uservalue is missing due to VARIANT handling*/
        PropertyDialog::SetCheckboxState(::GetDlgItem(GetHwnd(), 900),
                                         wall->m_d.m_tdr.m_TimerEnabled);
        break;
      }
      case eItemLight:
...
void BasePropertyDialog::UpdateBaseProperties(ISelect* psel,
                                              ...
                                              const int dispid)
{
  ...
  switch (dispid)
  {
    case IDC_HIT_THRESHOLD_EDIT:
      CHECK_UPDATE_ITEM(property->m_threshold,
                        PropertyDialog::GetFloatTextbox(*m_baseHitThresholdEdit), psel);
      break;
    case IDC_HAS_HITEVENT_CHECK:
      CHECK_UPDATE_ITEM(property->m_hitEvent, PropertyDialog::GetCheckboxState(m_hHitEventCheck),
                        psel);
      break;
    case IDC_ELASTICITY_EDIT:
      CHECK_UPDATE_ITEM(property->m_elasticity,
                        PropertyDialog::GetFloatTextbox(*m_baseElasticityEdit), psel);
      break;
    case IDC_COLLIDABLE_CHECK:
      CHECK_UPDATE_ITEM(property->m_collidable,
                        PropertyDialog::GetCheckboxState(m_hCollidableCheck), psel);
      break;
    case IDC_VISIBLE_CHECK:
      CHECK_UPDATE_ITEM(property->m_visible, PropertyDialog::GetCheckboxState(m_hVisibleCheck),
                        psel);
      break;
    case IDC_REFLECT_ENABLED_CHECK:
      CHECK_UPDATE_ITEM(property->m_reflectionEnabled,
                        PropertyDialog::GetCheckboxState(m_hReflectionEnabledCheck), psel);
      break;
    case IDC_FRICTION_EDIT:
      CHECK_UPDATE_ITEM(property->m_friction, PropertyDialog::GetFloatTextbox(*m_baseFrictionEdit),
                        psel);
      break;
    case IDC_SCATTER_ANGLE_EDIT:
      CHECK_UPDATE_ITEM(property->m_scatter,
                        PropertyDialog::GetFloatTextbox(*m_baseScatterAngleEdit), psel);
      break;
    case DISPID_Image:
    ...
    case IDC_MATERIAL_COMBO4:
      CHECK_UPDATE_COMBO_TEXT_STRING(property->m_szPhysicsMaterial, *m_basePhysicsMaterialCombo,
                                     psel);
      break;
    case IDC_OVERWRITE_MATERIAL_SETTINGS:
      CHECK_UPDATE_ITEM(property->m_overwritePhysics,
                        PropertyDialog::GetCheckboxState(m_hOverwritePhysicsCheck), psel);
      break;
  }
}
