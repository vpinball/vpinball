...
PrimitivePositionProperty::PrimitivePositionProperty(const VectorProtected<ISelect>* pvsel)
  : BasePropertyDialog(IDD_PROPPRIMITIVE_POSITION, pvsel)
{
  ...
  for (int i = 0; i < m_pvsel->size(); i++)
  {
    ...
    switch (dispid)
    {
      case DISPID_POSITION_X:
        CHECK_UPDATE_ITEM(prim->m_d.m_vPosition.x, PropertyDialog::GetFloatTextbox(m_posXEdit),
                          prim);
        break;
      case DISPID_POSITION_Y:
        CHECK_UPDATE_ITEM(prim->m_d.m_vPosition.y, PropertyDialog::GetFloatTextbox(m_posYEdit),
                          prim);
        break;
      case DISPID_POSITION_Z:
        CHECK_UPDATE_ITEM(prim->m_d.m_vPosition.z, PropertyDialog::GetFloatTextbox(m_posZEdit),
                          prim);
        break;
      case DISPID_SIZE_X:
      ...
      case DISPID_SIZE_Z:
        ...
        break;
      case DISPID_ROTRA1:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[0], PropertyDialog::GetFloatTextbox(m_rotXEdit),
                          prim);
        break;
      case DISPID_ROTRA2:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[1], PropertyDialog::GetFloatTextbox(m_rotYEdit),
                          prim);
        break;
      case DISPID_ROTRA3:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[2], PropertyDialog::GetFloatTextbox(m_rotZEdit),
                          prim);
        break;
      case DISPID_ROTRA4:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[3], PropertyDialog::GetFloatTextbox(m_transXEdit),
                          prim);
        break;
      case DISPID_ROTRA5:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[4], PropertyDialog::GetFloatTextbox(m_transYEdit),
                          prim);
        break;
      case DISPID_ROTRA6:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[5], PropertyDialog::GetFloatTextbox(m_transZEdit),
                          prim);
        break;
      case DISPID_ROTRA7:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[6], PropertyDialog::GetFloatTextbox(m_objRotXEdit),
                          prim);
        break;
      case DISPID_ROTRA8:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[7], PropertyDialog::GetFloatTextbox(m_objRotYEdit),
                          prim);
        break;
      case DISPID_ROTRA9:
        CHECK_UPDATE_ITEM(prim->m_d.m_aRotAndTra[8], PropertyDialog::GetFloatTextbox(m_objRotZEdit),
                          prim);
        break;
      default:
        break;
