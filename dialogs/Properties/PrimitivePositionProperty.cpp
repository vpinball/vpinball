...
BOOL PrimitivePositionProperty::OnInitDialog() 
{
    ...
    m_resizer.AddChild(GetDlgItem(IDC_STATIC1), leftcenter, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
    ...
    m_resizer.AddChild(GetDlgItem(IDC_STATIC21), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC22), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC23), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC24), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC25), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC26), leftcenter, 0);
    ...
    m_resizer.AddChild(m_transXEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_transYEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_transZEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_objRotXEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_objRotYEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_objRotZEdit, leftcenter, RD_STRETCH_WIDTH);
