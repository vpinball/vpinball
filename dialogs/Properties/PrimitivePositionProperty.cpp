...
BOOL PrimitivePositionProperty::OnInitDialog() 
{
    ...
    m_resizer.AddChild(GetDlgItem(IDC_STATIC21), topleft, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC22), topleft, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC23), topleft, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC24), topleft, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC25), topleft, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC26), topleft, 0);
