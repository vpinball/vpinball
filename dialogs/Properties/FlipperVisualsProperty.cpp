...
FlipperVisualsProperty::FlipperVisualsProperty(const VectorProtected<ISelect>* pvsel)
  : BasePropertyDialog(IDD_PROPFLIPPER_VISUALS, pvsel)
{
...
void FlipperVisualsProperty::UpdateProperties(const int dispid)
{
  for (int i = 0; i < m_pvsel->size(); i++)
  {
    ...
    {
      case 1:
        CHECK_UPDATE_ITEM(flipper->m_d.m_BaseRadius,
                          PropertyDialog::GetFloatTextbox(m_baseRadiusEdit), flipper);
        break;
      case 2:
        CHECK_UPDATE_ITEM(flipper->m_d.m_EndRadius,
                          PropertyDialog::GetFloatTextbox(m_endRadiusEdit), flipper);
        break;
      case 3:
        CHECK_UPDATE_ITEM(flipper->m_d.m_FlipperRadiusMax,
                          PropertyDialog::GetFloatTextbox(m_lengthEdit), flipper);
        break;
      case 4:
        CHECK_UPDATE_ITEM(flipper->m_d.m_StartAngle,
                          PropertyDialog::GetFloatTextbox(m_startAngleEdit), flipper);
        break;
      case 7:
        CHECK_UPDATE_ITEM(flipper->m_d.m_EndAngle, PropertyDialog::GetFloatTextbox(m_endAngleEdit),
                          flipper);
        break;
      case 13:
        CHECK_UPDATE_ITEM(flipper->m_d.m_Center.x, PropertyDialog::GetFloatTextbox(m_posXEdit),
                          flipper);
        break;
      case 14:
        CHECK_UPDATE_ITEM(flipper->m_d.m_Center.y, PropertyDialog::GetFloatTextbox(m_posYEdit),
                          flipper);
        break;
      case 18:
        CHECK_UPDATE_ITEM(flipper->m_d.m_rubberthickness,
                          PropertyDialog::GetFloatTextbox(m_rubberThicknessEdit), flipper);
        break;
      case 24:
        CHECK_UPDATE_ITEM(flipper->m_d.m_rubberheight,
                          PropertyDialog::GetFloatTextbox(m_rubberOffsetHeightEdit), flipper);
        break;
      case 25:
        CHECK_UPDATE_ITEM(flipper->m_d.m_rubberwidth,
                          PropertyDialog::GetFloatTextbox(m_rubberWidthEdit), flipper);
        break;
      case 107:
        CHECK_UPDATE_ITEM(flipper->m_d.m_height, PropertyDialog::GetFloatTextbox(m_heightEdit),
                          flipper);
        break;
      case 111:
        CHECK_UPDATE_VALUE_SETTER(flipper->SetFlipperRadiusMin, flipper->GetFlipperRadiusMin,
                                  PropertyDialog::GetFloatTextbox, m_maxDifficultLengthEdit,
                                  flipper);
        break;
      case 1502:
      ...
      case IDC_FLIPPER_ENABLED:
        CHECK_UPDATE_ITEM(flipper->m_d.m_enabled,
                          PropertyDialog::GetCheckboxState(::GetDlgItem(GetHwnd(), dispid)),
                          flipper);
        break;
      case IDC_MATERIAL_COMBO2:
        CHECK_UPDATE_COMBO_TEXT_STRING(flipper->m_d.m_szRubberMaterial, m_rubberMaterialCombo,
                                       flipper);
        break;
