...
BOOL PlungerVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(GetDlgItem(IDC_STATIC17), leftcenter, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC18), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC19), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC20), leftcenter, 0);
    ...
    m_resizer.AddChild(m_flatFramesEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_widthEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_zAdjustmentEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_rodDiameterEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_tipShapeEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringGapEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringDiamEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ringWidthEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_springDiamEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_springGaugeEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_springLoopsEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_endLoopsEdit, leftcenter, RD_STRETCH_WIDTH);
