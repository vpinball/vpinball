...
BOOL TextboxVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(GetDlgItem(IDC_STATIC5), leftcenter, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
    ...
    m_resizer.AddChild(m_hTransparentCheck, leftcenter, 0);
    m_resizer.AddChild(m_backgroundColorButton, leftcenter, 0);
    m_resizer.AddChild(m_textColorButton, leftcenter, 0);
    m_resizer.AddChild(m_fontDialogButton, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_alignmentCombo, leftcenter, RD_STRETCH_WIDTH);
    ...
    m_resizer.AddChild(m_textIntensityEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hUseScriptDMDCheck, leftcenter, 0);
