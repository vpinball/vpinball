...
BOOL TableCustomProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_SSAACombo, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_postProcAACombo, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_inGameAOCombo, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ScreenReflectionCombo, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_fpsLimiterEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_detailLevelSlider, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hOverwriteDetailsCheck, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ballReflectionCombo, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ballTrailCombo, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ballTrailStrengthEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_nightDaySlider, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hOverwriteNightDayCheck, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_gameplayDifficultEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_overwritePhysicsSetCombo, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hOverwriteFlipperCheck, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_soundEffectVolEdit, center, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_musicVolEdit, center, RD_STRETCH_WIDTH);
    return TRUE;
}
