...
BOOL TableCustomProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_SSAACombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_postProcAACombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_inGameAOCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ScreenReflectionCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_fpsLimiterEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_detailLevelSlider, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hOverwriteDetailsCheck, leftcenter, 0);
    m_resizer.AddChild(m_ballReflectionCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ballTrailCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_ballTrailStrengthEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_nightDaySlider, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hOverwriteNightDayCheck, leftcenter, 0);
    m_resizer.AddChild(m_gameplayDifficultEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_overwritePhysicsSetCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hOverwriteFlipperCheck, leftcenter, 0);
    m_resizer.AddChild(m_soundEffectVolEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_musicVolEdit, leftcenter, RD_STRETCH_WIDTH);
    return TRUE;
}
