...
DispreelVisualsProperty::DispreelVisualsProperty(const VectorProtected<ISelect>* pvsel)
  : BasePropertyDialog(IDD_PROPDISPREEL_VISUALS, pvsel)
{
  ...
  for (int i = 0; i < m_pvsel->size(); i++)
  {
    ...
    switch (dispid)
    {
      case IDC_BACK_TRANSP_CHECK:
        CHECK_UPDATE_ITEM(reel->m_d.m_transparent,
                          PropertyDialog::GetCheckboxState(m_hBackgroundTransparentCheck), reel);
        break;
      case IDC_USE_IMAGE_GRID_CHECK:
        CHECK_UPDATE_ITEM(reel->m_d.m_useImageGrid,
                          PropertyDialog::GetCheckboxState(m_hUseImageGridCheck), reel);
        break;
      case IDC_SINGLE_DIGIT_RANGE_EDIT:
        CHECK_UPDATE_VALUE_SETTER(reel->SetRange, reel->GetRange, PropertyDialog::GetIntTextbox,
                                  m_singleDigitRangeEdit, reel);
        break;
      case IDC_IMAGES_PER_ROW_EDIT:
        CHECK_UPDATE_VALUE_SETTER(reel->SetImagesPerGridRow, reel->GetImagesPerGridRow,
                                  PropertyDialog::GetIntTextbox, m_imagePerRowEdit, reel);
        break;
      case 9:
        CHECK_UPDATE_VALUE_SETTER(reel->SetX, reel->GetX, PropertyDialog::GetFloatTextbox,
                                  m_posXEdit, reel);
        break;
      case 10:
        CHECK_UPDATE_VALUE_SETTER(reel->SetY, reel->GetY, PropertyDialog::GetFloatTextbox,
                                  m_posYEdit, reel);
        break;
      case IDC_REELS_EDIT:
        CHECK_UPDATE_VALUE_SETTER(reel->SetReels, reel->GetReels, PropertyDialog::GetIntTextbox,
                                  m_reelsEdit, reel);
        break;
      case IDC_REEL_WIDTH_EDIT:
        CHECK_UPDATE_VALUE_SETTER(reel->SetWidth, reel->GetWidth, PropertyDialog::GetFloatTextbox,
                                  m_reelWidthEdit, reel);
        break;
      case IDC_REEL_HEIGHT_EDIT:
        CHECK_UPDATE_VALUE_SETTER(reel->SetHeight, reel->GetHeight, PropertyDialog::GetFloatTextbox,
                                  m_reelHeightEdit, reel);
        break;
      case IDC_REEL_SPACING_EDIT:
        CHECK_UPDATE_VALUE_SETTER(reel->SetSpacing, reel->GetSpacing,
                                  PropertyDialog::GetFloatTextbox, m_reelSpacingEdit, reel);
        break;
