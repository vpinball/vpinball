...
BOOL WallVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(m_topImageCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_sideImageCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_topMaterialCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_sideMaterialCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_slingshotMaterialCombo, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_disableLightingEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_disableLightFromBelowEdit, leftcenter, RD_STRETCH_WIDTH);
    ...
    m_resizer.AddChild(m_hDisplayInEditor, leftcenter, 0);
    m_resizer.AddChild(m_hTopImageVisible, leftcenter, 0);
    m_resizer.AddChild(m_hSideImageVisible, leftcenter, 0);
    m_resizer.AddChild(m_hAnimateSlingshot, leftcenter, 0);
    m_resizer.AddChild(m_hFlipbook, leftcenter, 0);
    m_resizer.AddChild(m_bottomHeightEdit, leftcenter, RD_STRETCH_WIDTH);
    return TRUE;
}
