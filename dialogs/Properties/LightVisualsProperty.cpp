...
BOOL LightVisualsProperty::OnInitDialog()
{
    ...
    m_resizer.AddChild(GetDlgItem(IDC_STATIC16), leftcenter, RD_STRETCH_WIDTH | RD_STRETCH_HEIGHT);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC17), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC18), leftcenter, 0);
    m_resizer.AddChild(GetDlgItem(IDC_STATIC19), leftcenter, 0);
    m_resizer.AddChild(m_falloffEdit, leftcenter, RD_STRETCH_WIDTH );
    m_resizer.AddChild(m_falloffPowerEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_intensityEdit, leftcenter, RD_STRETCH_WIDTH );
    m_resizer.AddChild(m_fadeSpeedUpEdit, leftcenter, 0);
    m_resizer.AddChild(m_fadeSpeedDownEdit, rightcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hPassThroughCheck, leftcenter, RD_STRETCH_WIDTH);
    ...
    m_resizer.AddChild(m_hEnableCheck, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hShowMeshCheck, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hStaticMeshCheck, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_haloHeightEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_scaleMeshEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_modulateEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_transmitEdit, leftcenter, RD_STRETCH_WIDTH);
    m_resizer.AddChild(m_hRelectOnBalls, leftcenter, RD_STRETCH_WIDTH);
