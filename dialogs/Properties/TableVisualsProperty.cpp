...
void TableVisualsProperty::UpdateProperties(const int dispid)
{
    ...
    {
        case DISPID_Image:
            CHECK_UPDATE_COMBO_TEXT_MAXTOKEN(table->m_szImage, m_imageCombo, table);
            break;
        case IDC_MATERIAL_COMBO:
            CHECK_UPDATE_COMBO_TEXT_MAXNAMEBUFFER(table->m_szPlayfieldMaterial, m_materialCombo, table);
            break;
        ...
        case IDC_BALL_DECAL_MODE:
            ...
            break;
        case 1505:
            CHECK_UPDATE_COMBO_TEXT_MAXTOKEN(table->m_szBallImage, m_ballImageCombo, table);
            break;
        case 1508:
            CHECK_UPDATE_COMBO_TEXT_MAXTOKEN(table->m_szBallImageDecal, m_ballDecalCombo, table);
            break;
