...
public:
  ...
  bool GetCaseSensitiveFilter() const { return m_isCaseSensitive; }
  void SetCaseSensitiveFilter(const bool enable) { m_isCaseSensitive = enable; }
...
public:
  ...
  LayersListDialog* GetLayersDialog() { return &m_layersDialog; }
...
public:
  ...
  CContainLayers* GetContainLayers() { return &m_layersContainer; }
