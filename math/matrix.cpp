...
void RotateAround(const Vertex3Ds& pvAxis,
                  Vertex3D_NoTex2* const pvPoint,
                  const int count,
                  const float angle)
{
  Matrix3 mat;
  ...
  for (int i = 0; i < count; ++i)
  {
    ...
    const float resultn[3] = {mat.m_d[0][0] * pvPoint[i].nx + mat.m_d[0][1] * pvPoint[i].ny +
                                  mat.m_d[0][2] * pvPoint[i].nz,
                              mat.m_d[1][0] * pvPoint[i].nx + mat.m_d[1][1] * pvPoint[i].ny +
                                  mat.m_d[1][2] * pvPoint[i].nz,
                              mat.m_d[2][0] * pvPoint[i].nx + mat.m_d[2][1] * pvPoint[i].ny +
                                  mat.m_d[2][2] * pvPoint[i].nz};
