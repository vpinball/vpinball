...
public:
  void PlayInternal(const float volume,
...
public:
  ...
  char*
      m_pdata; // wav: copy of the buffer/sample data so we can save it out, else: the contents of the original file
  int m_cdata;
