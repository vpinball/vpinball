...
| *PreciseGameTime | double | gets the current internal game time in seconds |
...
- `VPBuildVersion` - same as Version but with the github build number as decimal `GIT_REVISION / 10000.0`
