...
Function vpmKeyDown(ByVal keycode)
	...
	With Controller
		...
		Select Case keycode
			Case keyInsertCoin1  .Switch(swCoin1) = 1 : Playsound SCoin
			Case keyInsertCoin2  .Switch(swCoin2) = 1 : Playsound SCoin
			Case keyInsertCoin3  .Switch(swCoin3) = 1 : Playsound SCoin
