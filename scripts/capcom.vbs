...
Function vpmKeyDown(ByVal keycode)
	...
	With Controller
		Select Case keycode
			Case RightFlipperKey .Switch(swLRFlip) = True : vpmFlips.FlipR True : vpmKeyDown = False
			Case LeftFlipperKey  .Switch(swLLFlip) = True : vpmFlips.FlipL True : vpmKeyDown = False
...
Function vpmKeyUp(ByVal keycode)
	...
	With Controller
		Select Case keycode
			Case RightFlipperKey .Switch(swLRFlip) = False : vpmFlips.FlipR False : vpmKeyUp = False
			Case LeftFlipperKey  .Switch(swLLFlip) = False : vpmFlips.FlipL False : vpmKeyUp = False
