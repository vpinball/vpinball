...
class cvpmNudge2
	...
	Private Sub Class_Initialize
		...
		TiempoFiltro = 1000		' nudge filtering time in ms
		ReturnTime = 200		' time after which return force bumps in
		ReturnPercent = 100		' return force strength 0-100
	...
	Public Sub DoNudge(ByVal aDir, ByVal aForce)
		...
		mcount2 = 1
		mReturnCount = 1
		If aDir < 5 or aDir > 355 Then aDir = aDir + 180 : aForce = 1 : ReturnPercent = 50
        If aDir >= 5 and aDir <= 175 Then aDir = 120 : aForce = 1 : ReturnPercent = 85
        If aDir >= 185 and aDir <= 355 Then aDir = 240 : aForce = 1 : ReturnPercent = 85
