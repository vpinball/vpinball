...
class
    BaseProperty // not everything in here is used in all of the derived classes, but it simplifies the UI code!
{
public:
...
public:
  ...
  virtual Vertex2D GetScale() const { return Vertex2D(1.f, 1.f); }
  ...
  unsigned char
      m_oldLayerIndex; //!! deprecated, leave it here for compatibility reasons. To load old tables to new layer handling
