...
class BallEx : public CComObjectRootEx<CComSingleThreadModel>,
...
public:
  ...
  STDMETHOD(put_AngVelZ)(/*[out, retval]*/ float newVal)
  {
    return S_OK;
  } // No-op to not break tables.
  STDMETHOD(get_AngVelY)(/*[out, retval]*/ float* pVal);
  STDMETHOD(put_AngVelY)(/*[out, retval]*/ float newVal)
  {
    return S_OK;
  } // No-op to not break tables.
  STDMETHOD(get_AngVelX)(/*[out, retval]*/ float* pVal);
  STDMETHOD(put_AngVelX)(/*[out, retval]*/ float newVal)
  {
    return S_OK;
  } // No-op to not break tables.
