#pragma once
#define FID(A) \
  (int)((unsigned int)(#A[0]) | ((unsigned int)(#A[1]) << 8) | ((unsigned int)(#A[2]) << 16) | \
        ((unsigned int)(#A[3]) << 24))
...
public:
  ...
  long __stdcall CreateStream(
      const WCHAR*, unsigned long, unsigned long, unsigned long, struct IStream**);
  long __stdcall OpenStream(const WCHAR*, void*, unsigned long, unsigned long, struct IStream**);
  long __stdcall CreateStorage(
      const WCHAR*, unsigned long, unsigned long, unsigned long, struct IStorage**);
  long __stdcall OpenStorage(
  ...
  long __stdcall SetElementTimes(const WCHAR*,
...
public:
  ...
  long __stdcall CopyTo(struct IStream*,
